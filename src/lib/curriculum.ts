...
const onboardingLessons: Lesson[] = [
  {
    ...
    quiz: [
      { q: 'What are the three phases a lesson can have?', options: ['Learn, Practice, Apply', 'Start, Middle, End', 'Bronze, Silver, Gold', 'Read, Watch, Repeat'], correct: 0, explain: 'Learn is the reading, Practice is the quiz, and Apply — on lessons that have one — is a live scenario with an AI guest.' },
      { q: 'When does a lesson count as fully complete?', options: ['After you read the Learn phase', 'When you finish every phase it has — including passing the live scenario if there is one', 'When your manager marks it done', 'As soon as you open it'], correct: 1, explain: 'A lesson is complete when every phase it has is finished. If it ends in a live scenario, passing that scenario is part of completing it — and that\'s also when the lesson\'s XP is paid out.' },
  ...
  },
  {
    ...
    quiz: [
      ...
      { q: 'At [Property], when a decision is made, what comes first?', options: ['The fastest option, always.', 'The bottom line and turning tables quickly.', 'The guest\'s experience — revenue follows hospitality.', 'Whatever is easiest for staff.'], correct: 2, explain: 'We lead with hospitality. Profit is the result of caring for guests well — never the starting point.' },
      { q: 'A table needs clearing but it\'s technically in another server\'s section. What does our DNA say?', options: ['Report it to a manager and move on.', 'Leave it — it\'s not your job.', 'Wait for the assigned server to handle it.', 'Handle it — at [Property] everyone owns the guest experience.'], correct: 3, explain: 'We are a team, not a hierarchy. "That\'s not my job" has no place here — if something needs doing, we do it.' },
      { q: 'Why do we obsess over small details like a polished glass or a remembered name?', options: ['Because the details are what guests actually feel — they signal real care.', 'Because they\'re required by law.', 'They don\'t really matter; the food is all that counts.', 'Because health inspectors check for them.'], correct: 0, explain: 'Craft and pride live in the small things. Details are how a guest feels cared for, even if they can\'t name why.' },
  ...
  },
  {
    ...
    quiz: [
      { q: 'Why does [Property] hold every team member to the same standards?', options: ['To make new staff feel pressured.', 'To make the rules feel strict.', 'So guests get the same excellent experience every time, regardless of who\'s working or how busy it is.', 'Because corporate requires it.'], correct: 2, explain: 'Standards exist for consistency — a guest should never be able to tell if it\'s your first shift or your five-hundredth.' },
      { q: 'The kitchen is 20 minutes behind and you\'re stressed. A guest at your table looks up. What should they see?', options: ['You venting about the kitchen so they understand the delay.', 'You avoiding eye contact until things calm down.', 'Your honest frustration — guests appreciate authenticity.', 'A composed, positive attitude — the stress behind service stays invisible.'], correct: 3, explain: 'Guests never see the stress behind service. Composure on the floor is part of the standard, especially when things go wrong.' },
      { q: 'When does representing [Property] begin and end?', options: ['The moment you put on the uniform — and it extends to how you act online and in the community.', 'Only during interactions with guests.', 'Only while you\'re clocked in and on the floor.', 'Only when a manager is watching.'], correct: 0, explain: 'You represent the brand on and off shift, including online. While you wear the name, it\'s yours to protect.' },
  ...
  },
  {
    ...
    quiz: [
      { q: 'Why does knowing our guest profiles matter?', options: ['So you can decide who deserves better service.', 'It doesn\'t really matter — good food serves everyone equally.', 'So you can serve everyone in exactly the same way.', 'So you can read who\'s in front of you and anticipate their needs before they\'re spoken.'], correct: 3, explain: 'The best staff adjust to the guest in front of them. Knowing profiles helps you anticipate needs instead of reacting to them.' },
      { q: 'A regular walks in for the third time this week. What do they value most?', options: ['Being treated like family — name remembered, usual known, welcomed back warmly.', 'A formal, by-the-book greeting.', 'Being left completely alone.', 'The fastest possible service.'], correct: 0, explain: 'Familiarity is the whole point for regulars. They forgive a busy night, but never being treated like a stranger.' },
      { q: 'A first-time guest is staring at the menu, clearly unsure. Best move?', options: ['Tell them to order whatever looks good.', 'Offer to guide them — "Want me to walk you through our favorites?"', 'Bring the bill early to keep things moving.', 'Give them more time alone to figure it out.'], correct: 1, explain: 'First-timers rely on you completely. Guiding them makes them feel like insiders — and often turns into a five-star review.' },
      { q: 'You learn a table is celebrating an engagement. What should you do?', options: ['Wait for them to mention it again before acting.', 'Treat it like any other table to avoid pressure.', 'Acknowledge the occasion genuinely and quietly flag the team to protect the moment.', 'Announce it loudly to the whole dining room immediately.'], correct: 2, explain: 'Celebration guests remember how the moment felt. Acknowledging it early and coordinating with the team is how we earn their future milestones.' },
      { q: 'You can\'t tell what a new table needs — they\'re hard to read. What\'s the best approach?', options: ['Give them space and avoid checking in.', 'Default to your fastest, most efficient script.', 'Treat them exactly like the last table you served.', 'Ask warmly and listen — guests will tell you how they want to be treated.'], correct: 3, explain: 'Never apply one script to every table. When unsure, a warm question and genuine listening lets the guest show you what they need.' },
    ],
  },
  {
    id: 'your-first-shift',
    ...
    quiz: [
      { q: 'What\'s the right mindset to bring to your first shift?', options: ['Show up ready, stay observant, and ask good questions — nobody expects perfection.', 'Stay quiet and avoid asking anything so you don\'t look new.', 'Take on as many tables as possible to impress your manager.', 'Prove you already know everything so the team trusts you.'], correct: 0, explain: 'Day one is for learning the floor, not passing a test. The staff who thrive observe closely and ask rather than pretending to know.' },
      { q: 'You\'re unsure which side to serve a plate from, mid-service. What\'s the most professional move?', options: ['Skip serving that guest entirely.', 'Quickly ask your trainer — asking looks more professional than guessing wrong in front of a guest.', 'Serve from whichever side is closest.', 'Guess and hope it\'s right.'], correct: 1, explain: 'Asking when you can ask shows you care about getting it right. A wrong guess in front of a guest costs far more than a quick question.' },
      ...
      { q: 'When should you arrive for your first shift?', options: ['A few minutes late is fine on day one.', 'Whenever, since you\'re only shadowing.', 'Right at your start time.', 'About 15 minutes early, so you can check in and find out where to start.'], correct: 3, explain: 'Arriving early lets you introduce yourself, get oriented, and start on time — it sets the tone for how reliable you\'ll be.' },
      { q: 'After your first shift ends, what\'s the smartest thing to do?', options: ['Ask your trainer what you did well and what to work on, and note it for next time.', 'Wait for your next shift to think about how it went.', 'Only ask for feedback if something went wrong.', 'Leave quickly — the work is done.'], correct: 0, explain: 'A short debrief turns one shift into real progress. Reflecting and writing down what to improve is how strong staff grow fast.' },
    ],
  },
  {
    id: 'our-menu-pdf',
    ...
    quiz: [
      ...
      { q: 'Why is it worth knowing the price and what each dish includes?', options: ['So you can decide which guests can afford what.', 'So you can upsell guests on everything.', 'So you can set expectations clearly — what comes with the dish and what costs extra.', 'Prices don\'t matter to servers.'], correct: 2, explain: 'Knowing exactly what a dish includes lets you set honest expectations and avoid surprises on the bill.' },
      { q: 'A guest says they\'re vegan. Because you studied the menu, you can:', options: ['Guess which dishes might work.', 'Ask them to check with the kitchen themselves.', 'Tell them there\'s probably nothing for them.', 'Point them confidently to vegan dishes and ones that can be adapted.'], correct: 3, explain: 'Knowing the dietary options in advance means a vegan guest feels taken care of instead of like an afterthought.' },
      { q: 'What separates a good server from a great one, according to this lesson?', options: ['Knowing every dish — its ingredients, preparation, and price.', 'Memorizing only the most expensive items.', 'Being friendly without knowing the menu.', 'Speed of service alone.'], correct: 0, explain: 'Deep menu knowledge — ingredients, preparation, and price — is exactly what elevates good service into great service.' },
...
const greetingsLessons: Lesson[] = [
  {
    ...
    quiz: [
      { q: 'A guest walks in while you\'re explaining something to a colleague. What do you do?', options: ['Wait for them to approach you.', 'Finish your explanation, then greet the guest.', 'Make eye contact with the guest, hold up one finger, and finish within 10 seconds.', 'Ignore them — they can see you\'re busy.'], correct: 2, explain: 'Acknowledging immediately — even non-verbally — tells the guest they\'ve been seen. Finishing a thought within 10 seconds is acceptable; ignoring them is not.' },
      { q: 'You have a reservation for the Santos family. They walk in. Best opening?', options: ['"Name on the reservation?"', '"How many in your party?"', '"Santos? Right this way."', '"Mr. Santos, welcome to [Property]! We\'ve been expecting you."'], correct: 3, explain: 'Using their name + warmth + context ("we\'ve been expecting you") is the high-impact opening that makes guests feel like VIPs.' },
      { q: 'What is the [Property] standard for greeting speed?', options: ['5 seconds', '1 minute', '30 seconds', '10 seconds'], correct: 0, explain: '5 seconds is the standard. Every guest should be acknowledged within 5 seconds of walking through the door.' },
      ...
      { q: 'A regular guest, Erik, walks in every Tuesday. You recognize him. Best move?', options: ['"Table for one?"', 'Standard greeting: "Welcome to [Property]."', '"Erik! Good to see you — your usual spot in the corner?"', '"Name on reservation?"'], correct: 2, explain: 'Regulars are gold. Using their name, referencing their habit — this is what creates loyalty. It costs 3 seconds and earns a lifetime.' },
    ],
  },
  {
    id: 'guide-dont-point',
    ...
    quiz: [
      { q: 'A couple arrives. Every table is visible from the entrance. You should:', options: ['Tell them the table number.', 'Point to their table: "Just over there."', 'Hand them a menu and let them find it.', 'Walk them to the table, menu in hand.'], correct: 3, explain: 'Even when the restaurant is small, escorting the guest creates a feeling of personal service. Always walk them there.' },
      { q: 'As you escort guests, you should:', options: ['Mention something about the menu or what\'s special tonight.', 'Ask them all your demographic questions.', 'Rush to seat them quickly.', 'Walk in silence so they can enjoy the atmosphere.'], correct: 0, explain: 'One natural, genuine line about the experience creates anticipation and starts the conversation on a high note.' },
      ...
      { q: 'What does carrying the menu open as you walk communicate?', options: ['Nothing — it\'s just habit.', 'You\'re in a hurry.', 'Readiness and care — you\'re already thinking about their experience.', 'You don\'t have enough staff to carry it properly.'], correct: 2, explain: 'Small gestures communicate big things. An open menu says: "I\'m already thinking about your experience." It\'s a statement of readiness.' },
      { q: 'A group arrives and says "Oh, we know where to go!" Should you still escort them?', options: ['Yes, but just hand them menus without walking.', 'No — only escort first-time guests.', 'No — respect their preference, let them go.', 'Yes — walk with them and mention something on the menu anyway.'], correct: 3, explain: 'Even for regulars, walking with them (at their pace) and adding something warm creates connection. You can be brief — "Right this way then, good to have you back" — but walk.' },
    ],
  },
  {
    id: 'multilingual',
    ...
    quiz: [
      { q: 'A Dutch couple walks in — well-dressed, efficient body language. Best opening?', options: ['"Welkom bij [Property]. Fijn dat u er bent. Tafel voor twee?"', '"Welcome! Can I get a name for the reservation?"', '"Bon biní! Kon ta bai?"', '"Hey!! Welcome, so great to see you!!"'], correct: 0, explain: 'Dutch guests appreciate a clean, efficient, warm greeting in their own language. Not over-the-top — just genuinely professional.' },
      { q: 'How do you say "Welcome" in Papiamentu?', options: ['Danki', 'Bon biní', 'Bon nochi', 'Bon dia'], correct: 1, explain: 'Bon biní = welcome. Bon dia = good morning. Danki = thank you. Bon nochi = good evening.' },
      { q: 'A Venezuelan family arrives. They\'re speaking Spanish. What\'s the highest-impact opening?', options: ['"Welkom bij [Property]."', '"Welcome to [Property], how many?"', '"¡Hola! Bienvenidos — qué gusto verlos. ¿Cuántos son?"', '"Table for four?"'], correct: 2, explain: 'Spanish + genuine warmth + interest in their group = instant connection. This family will remember this moment.' },
      { q: 'An American couple mentions it\'s their anniversary as they walk in. What do you do?', options: ['Don\'t mention it to avoid making them uncomfortable.', 'Standard check-in and seating.', 'Note it for later — bring it up at dessert.', '"Oh, congratulations! We\'re so happy you chose us for this evening."'], correct: 3, explain: 'Americans light up when you acknowledge occasions with genuine enthusiasm. This is not awkward — this is service.' },
      { q: 'What does "Bon tardi" mean?', options: ['Good afternoon', 'Good morning', 'Good evening', 'Thank you'], correct: 0, explain: 'Bon tardi = good afternoon. Bon dia = morning. Bon nochi = evening. Bon biní = welcome.' },
    ],
  },
  {
    id: 'reading-table',
...
const physicalCraftLessons: Lesson[] = [
  {
    ...
    quiz: [
      { q: 'Which hand should always carry the tray?', options: ['Both hands together', 'Right hand', 'Left hand', 'Either hand'], correct: 2, explain: 'Left hand always — this keeps your right hand free to open doors, guide guests, or steady items.' },
      { q: 'Where do heavy items go on the tray?', options: ['Left side to balance your arm', "It doesn't matter", 'Outer edges for easy access', 'Center of the tray'], correct: 3, explain: 'Heavy items center — this keeps the weight balanced over your palm. Heavy items on the edge tip the tray.' },
      { q: 'Your tray feels unstable while walking. What do you do?', options: ['Stop completely, steady the tray, then continue', 'Grab the tray with both hands and carry it in front of you', 'Ask a colleague to take it', 'Speed up to get to the table faster'], correct: 0, explain: "Stop and steady. Never rush through instability. A moment's pause is better than a full tray on the floor." },
      ...
      { q: 'The path to table 7 goes through a narrow corridor. You should:', options: ['Put the tray down and carry plates by hand', 'Go through carefully, holding the tray high', 'Find an alternate route, never use narrow paths with a tray', 'Ask a colleague to clear the way'], correct: 2, explain: "Never use narrow or busy paths. Plan your route before you load the tray. If you can't walk through comfortably, find another way." },
    ],
  },
  {
    id: 'plate-carrying',
    ...
    quiz: [
      { q: 'When carrying one plate, which fingers go under the plate?', options: ['All five fingers spread', 'Pinky and ring finger', 'Thumb and index finger only', 'Three middle fingers together'], correct: 3, explain: 'Three middle fingers together give a stable flat surface. Thumb and pinky act as side guides.' },
      { q: 'For a two-plate carry, where does the second plate rest?', options: ['On the thumb muscle at the base of your hand', 'Balanced on your forearm', 'In your other hand', 'On top of the first plate'], correct: 0, explain: 'The thumb muscle (base of thumb) gives a wide, stable surface for the second plate to rest on.' },
      ...
      { q: "What's wrong with tilting a plate while carrying it?", options: ['Guests prefer seeing the food from an angle', "Nothing — it's faster", 'It looks unprofessional and can spill the food or sauce', 'It makes the plate easier to carry'], correct: 2, explain: 'A tilted plate tells the guest you are rushing. It also risks spilling sauce or liquid — always keep plates level.' },
      { q: 'You are mid-service and one of your three plates starts slipping. What now?', options: ['Speed up to get to the table faster', 'Call for help loudly', 'Tighten your grip and keep walking', 'Stop immediately, find a stable surface, reset your grip'], correct: 3, explain: 'Stop immediately. A plate on the floor — or on a guest — is worse than a brief pause. Always choose safety over speed.' },
    ],
  },
  {
    id: 'floor-movement',
    ...
    quiz: [
      { q: 'On which side of corridors and pathways should you always walk?', options: ['Right side', 'Either side', 'Down the middle', 'Left side'], correct: 0, explain: 'Always walk on the right side of corridors. This prevents collisions and creates a natural flow of traffic through the space.' },
      ...
      { q: 'You are approaching a kitchen door exit with a full tray. You should:', options: ['Announce loudly that you are coming through', 'Walk through quickly to save time', 'Slow down and look before entering or exiting', 'Use your shoulder to push through'], correct: 2, explain: 'Kitchen door exits are danger zones — always slow down and look before entering or exiting. A moment of caution prevents a collision.' },
      { q: 'You notice a wet floor near table 5 during service. What is the correct action?', options: ['Clean it yourself while still carrying items', 'Let guests know to be careful', 'Walk carefully and continue with service', 'Tell a manager immediately and avoid the area'], correct: 3, explain: 'Never rush on a wet floor. Alert a manager immediately and avoid the area. Safety first — service waits.' },
      { q: 'A colleague runs across the dining room to reach the pass. What does that communicate to the room?', options: ['That something is wrong — running signals panic.', 'That the team is responsive and on top of the service.', 'Nothing at all — guests stay focused on their own tables.', 'That the floor is busy, which guests expect at peak times.'], correct: 0, explain: 'Never run and never shuffle. Running signals panic and stresses the whole room; shuffling signals disengagement. Smooth, quiet, purposeful movement is what tells guests the floor is under control.' },
    ],
  },
  {
    id: 'table-setting',
    ...
    quiz: [
      ...
      { q: 'Where should the water glass be placed in a standard cover?', options: ['In the center of the cover', 'Directly above the fork', 'Above the knife, slightly to the right', 'To the left of the fork'], correct: 2, explain: 'Water glass goes above the knife, positioned slightly to the right. This is the standard cover position.' },
      { q: 'How should you hold a glass when polishing it?', options: ['By the rim', 'By the base', 'By the bowl for a firm grip', 'By the stem only'], correct: 3, explain: 'Always hold glasses by the stem when polishing — never the bowl. Fingerprints on the bowl require re-polishing and are visible to guests.' },
      { q: 'A glass still has a streak after polishing. What do you do?', options: ['Polish it again until completely streak-free', "Place it anyway — guests won't notice in the lighting", 'Use a damp cloth to remove the streak', 'Turn it streak-side away from the guest'], correct: 0, explain: 'A smudged or streaked glass never goes to a guest table. Polish again until it passes the light test.' },
      { q: 'You find a small chip on one plate while resetting a table. What do you do?', options: ["Use it — it's only a small chip", 'Remove it from service immediately', 'Place it with the chip facing down, away from the guest', 'Place it at the bottom of the stack'], correct: 1, explain: 'Chipped or damaged plates are removed from service immediately — no exceptions. A chipped plate is a safety concern and signals poor standards.' },
    ],
  },
  {
    ...
    quiz: [
      { q: 'A table of 5 is ready for their mains — but one plate is 2 minutes behind. You:', options: ['Ask the guest whose plate is late to wait', "Serve the 4 ready plates — guests shouldn't wait", 'Wait for all 5 plates before leaving the kitchen', 'Warn the guests that one plate is coming separately'], correct: 2, explain: 'All plates go out together — non-negotiable. One person eating while four others watch is worse than a 2-minute hold.' },
      { q: 'The 3-second rule of synchronized service means:', options: ['Food should reach the table within 3 seconds of leaving the kitchen', 'Clearing should take no more than 3 seconds', 'Each plate should be placed within 3 seconds', 'All team members arrive at the table within 3 seconds of each other'], correct: 3, explain: 'All servers arrive at the table within 3 seconds of each other — not 30, not 10. Three. This is what makes service look choreographed rather than chaotic.' },
      { q: 'How do you coordinate with your team during synchronized service without disturbing guests?', options: ['Eye contact and small nods — silent visual communication', 'Pre-plan all movements before service starts', 'Whisper quietly near the kitchen', 'Use a headset communication system'], correct: 0, explain: 'Silent communication — eye contact and nods — keeps coordination invisible to guests. Verbal coordination in front of a table breaks the experience.' },
      { q: 'Who owns the timing and calls the pace of service for a table?', options: ['The captain, who manages the whole floor', 'The server, who owns the guest relationship', 'The kitchen, which sets the pace', 'The runner, who controls kitchen timing'], correct: 1, explain: 'The server owns the guest relationship and calls the timing. Runners support logistics. The captain coordinates the floor. But timing comes from the person closest to the guest.' },
...
const serviceFlowLessons: Lesson[] = [
  // 3 lessons: ten-steps, proactive-reactive, nonverbal-signals
  {
    ...
    quiz: [
      { q: 'Step 3 (First Contact) should happen within how long of guests being seated?', options: ['30 seconds', '10 minutes', '5 minutes', '2 minutes'], correct: 3, explain: 'First contact — offering water and a brief concept introduction — should happen within 2 minutes of seating. It sets the service tone.' },
      { q: 'Which step comes directly after Food Service?', options: ['Follow-up', 'Close', 'Clearing', 'Dessert/Digestifs'], correct: 0, explain: 'Step 7 is Follow-up: check in 2-3 minutes after food arrives. Clearing (Step 8) comes after the follow-up.' },
      { q: 'A guest finishes their main course while two others are still eating. You should:', options: ['Ask if you can clear their plate.', 'Wait until everyone finishes, then clear simultaneously.', 'Clear when the second person finishes.', 'Clear their plate immediately — it\'s polite.'], correct: 1, explain: 'Never clear while someone is still eating. Wait for the last person to finish, then clear all plates together (Step 8 — synchronized clearing).' },
      ...
      { q: 'What makes a close "personalized"?', options: ['A smile and a wave.', 'Offering a discount for their next visit.', 'Handing over a feedback form.', 'Using their name and inviting them back with a genuine reference to their visit.'], correct: 3, explain: 'The close (Step 10) uses the guest\'s name when you have it and includes a genuine invitation to return — not just "have a good night."' },
    ],
  },
  {
    ...
    quiz: [
      { q: 'A guest reaches for their water glass — it\'s half empty. 5-star service means:', options: ['Refilling before they have to ask or reach.', 'Asking the runner to handle refills.', 'Waiting for them to finish before offering a refill.', 'Asking "Would you like more water?"'], correct: 0, explain: 'Proactive service happens before the guest has to act. If they\'re already reaching, you\'re reacting — refill when the glass drops below half.' },
      { q: 'A guest glances at their watch twice during dinner. You should:', options: ['Ask "Are you in a hurry?"', 'Proactively offer to move the next course along: "I can have your main out in 8 minutes if that helps."', 'Bring the bill immediately.', 'Ignore it — it\'s not your business.'], correct: 1, explain: 'A glance at the watch is a signal. Offering to help without waiting for them to ask is 5-star service — anticipate, don\'t react.' },
      { q: 'The anticipation formula in correct order is:', options: ['Ask → Observe → Respond', 'Ask → Interpret → Act', 'Observe → Interpret → Act', 'Observe → Act → Confirm'], correct: 2, explain: 'Observe what\'s happening → Interpret what it means → Act before they ask. This sequence is the core of proactive service.' },
      { q: 'A family with two young kids is seated. Proactive service means:', options: ['Prioritizing the children\'s orders first.', 'Waiting for the parents to ask for what the kids need.', 'Asking "Do you need anything for the children?"', 'Bringing crayons and a kids\' menu without being asked.'], correct: 3, explain: 'Parents are watching whether you anticipate their family\'s needs. Bringing kids\' items without prompting signals experience and care — no one had to ask.' },
      { q: 'A couple at your table goes quiet and both lean back. This is your cue to:', options: ['Give them space — a comfortable silence is theirs, not a service moment.', 'Clear the table immediately.', 'Offer dessert right away.', 'Approach immediately to check in.'], correct: 0, explain: 'Not every moment is a service moment. Read the quiet and give space — coming in now would interrupt their experience.' },
    ],
  },
  {
    ...
    quiz: [
      { q: 'A guest closes their menu and places it on the table. This signals:', options: ['They need more time.', 'They are ready to order.', 'They\'re unhappy with the options.', 'They want to leave.'], correct: 1, explain: 'A closed menu placed on the table is one of the clearest order signals in hospitality. Approach calmly and naturally — they\'ve decided.' },
      { q: 'Two guests are leaning forward in animated conversation. You should:', options: ['Come back in 10 minutes without checking.', 'Approach immediately to take their order.', 'Wait for a natural pause or eye contact before approaching.', 'Tap one of them on the shoulder to signal you\'re there.'], correct: 2, explain: 'Leaning forward + active conversation = do not interrupt. Wait for a natural pause, eye contact, or a closed menu before approaching.' },
      { q: 'A solo guest has their phone on the table and is eating quickly. This suggests:', options: ['They\'ll definitely want dessert.', 'They\'re unhappy and distracted.', 'They want a long conversation about the food.', 'They want efficient service — clean, quick, no hovering.'], correct: 3, explain: 'Phone visible + eating quickly = working mode or time-pressured. Efficient, no-frills service is what they want. Check in, confirm all is well, and move on.' },
      { q: 'A guest keeps looking around the restaurant. What\'s happening?', options: ['They need service and are looking for a staff member.', 'They\'re bored.', 'They\'re enjoying the decor.', 'They\'re waiting for someone.'], correct: 0, explain: 'Looking around is the classic signal for "I need service." Don\'t wait for them to flag you — catch their eye, nod, and get there within 60 seconds.' },
...
const languageLessons: Lesson[] = [
  {
    ...
    quiz: [
      ...
      { q: 'A guest asks to move to another table. That table is reserved. You say:', options: ['"I don\'t think that\'s going to work."', '"We can\'t do that — it\'s reserved."', '"That\'s not possible tonight."', '"What I can do is check if there\'s a comparable table available — give me one moment."'], correct: 3, explain: '"What I can do is..." pivots immediately from limitation to solution. Never say "we can\'t" — always reframe toward what you can offer.' },
      { q: 'A guest thanks you for handling a problem quickly. Which response is correct?', options: ['"Absolutely — my pleasure."', '"That\'s what I\'m here for."', '"No problem!"', '"No worries!"'], correct: 0, explain: '"No problem" implies there could have been a problem. "Absolutely — my pleasure" signals that serving them is genuinely enjoyable. That\'s a completely different message.' },
      { q: 'A guest asks about an ingredient in a dish. You\'re not certain. You say:', options: ['"I think it should be fine."', '"I\'m not certain — let me find out for you right now."', '"Ask the kitchen."', '"I don\'t know."'], correct: 1, explain: '"I don\'t know" alone is never acceptable in front of a guest. Always follow it with immediate action: "let me find out right now" turns a gap into a service moment.' },
...

  {
    ...
    quiz: [
      { q: 'Which description correctly uses the 3-part formula?', options: ['"This is a classic beef burger with lettuce, tomato, and sauce."', '"This dish is very popular with guests."', '"This is our burger — it\'s really good."', '"This starts with freshly ground beef, seared on cast iron, giving you a crust that holds all the juice inside."'], correct: 3, explain: 'Star (freshly ground beef) + Method (seared on cast iron) + Experience (crust that holds the juice) = the 3-part formula working perfectly. The others describe without selling.' },
      { q: 'A guest asks about your signature cocktail. Best response:', options: ['"This opens with dark rum, shaken with fresh citrus and house bitters, and finishes with a long warming note that\'s completely ours."', '"It\'s really refreshing — most guests love it."', '"It\'s our most popular drink."', '"It has rum, citrus, and a mint finish."'], correct: 0, explain: 'The formula works for drinks too. Star → Method → Experience. Lead with what makes it special — not just an ingredient list.' },
      ...
      { q: 'Which phrase is forbidden when describing a dish?', options: ['"Slow-smoked for 8 hours."', '"You\'ll taste the technique in every bite."', '"This gives you a smoky, rich finish."', '"It\'s good."'], correct: 3, explain: '"It\'s good" is the laziest phrase in hospitality. Every other option builds desire — "it\'s good" destroys it. Tell them WHY it\'s good.' },
    ],
  },

  {
    ...
    quiz: [
      { q: 'A guest asks "What\'s special about this place?" Best response:', options: ['"This started as one dish — the owner made it on opening night. Guests kept coming back for it specifically. Everything else grew from that."', '"Check the menu — it explains our concept."', '"We have great food and a beautiful location."', '"We\'ve been open for 5 years."'], correct: 0, explain: 'An Origin Story answers the emotional question behind "what\'s special?" — not the factual one. Facts list. Stories connect.' },
      { q: 'Instead of "We use fresh ingredients," say:', options: ['"Everything here is fresh, locally sourced."', '"Our vegetables come from a local farm in the interior — picked this morning."', '"We care a lot about quality."', '"Our ingredients are very fresh."'], correct: 1, explain: 'Specificity is what makes a story credible and memorable. "A farm in the interior, picked this morning" puts a picture in the guest\'s mind. "Fresh ingredients" puts nothing.' },
      ...
      { q: 'When should you use a story?', options: ['At the close of every service, as a farewell.', 'When the kitchen is running behind and you need to buy time.', 'Only when a guest asks a direct question about the menu.', 'When a guest seems undecided, asks what\'s special, or you\'re describing a premium item.'], correct: 3, explain: 'Stories work best when a guest is undecided, curious about the property, or considering a premium item. Timing matters — the right story at the wrong moment is just noise.' },
      { q: 'A Process Story is best used to:', options: ['Justify the price and build excitement for how something is made', 'Reference other guests\' positive experiences', 'Explain why an item is unavailable', 'Create nostalgia and connection to heritage'], correct: 0, explain: '"Slow-smoked for 8 hours over local wood" is worth more than any price tag explanation. The Process Story builds excitement and makes the craft visible — which is what justifies premium pricing.' },
    ],
  },

  {
    ...
    quiz: [
      { q: 'Why does "I\'m sorry but..." fail as an apology?', options: ['It is too brief to read as genuinely sincere.', 'The "but" cancels the apology and turns it into a defence.', 'Nothing fails — it works perfectly well if you say it warmly enough.', 'It is too informal a register for a complaint.'], correct: 1, explain: '"But" undoes everything in front of it. The guest hears the justification, not the apology — which is why the phrase sits on the prohibited list next to "that\'s never happened before."' },
      { q: 'What makes "I\'ll be back with you in two minutes" stronger than "I\'ll look into it"?', options: ['It gives you a deadline that the kitchen has agreed to.', 'It avoids admitting that anything actually went wrong.', 'It commits to a specific action and a specific time.', 'It sounds more formal and therefore more professional.'], correct: 2, explain: 'Vague reassurance asks the guest to keep waiting on trust alone. A named action and a named time give them something concrete to hold — the difference between a guest who settles and one who keeps watching the door.' },
      { q: 'Which response is prohibited in complaint handling?', options: ['Checking back after the fix', 'Acknowledging the guest\'s frustration', 'Offering a concrete solution immediately', '"The kitchen was backed up — that\'s why it happened."'], correct: 3, explain: 'Blaming the kitchen — or any circumstance — shifts responsibility away from you and makes the guest feel like a problem. Never deflect. Own it entirely.' },
      { q: 'A guest receives the wrong order. The correct response is:', options: ['"I\'m so sorry about that. Let me fix this for you immediately."', '"Which server took your order?"', '"The ticket showed [X] — let me show you."', '"That sometimes happens with our system."'], correct: 0, explain: 'It doesn\'t matter how it happened — only how you fix it. Defending the process or questioning the guest signals that you value being right over their experience.' },
      { q: 'Which phrase tells a guest you do not believe them?', options: ['"Can I bring you something while you wait?"', '"Are you sure? That\'s never happened before."', '"Let me get that sorted for you right now."', '"I completely understand, and I\'m sorry this happened."'], correct: 1, explain: 'Questioning a guest\'s account is the fastest way to lose them. "Are you sure?" and "that\'s never happened before" say the same thing — that you think they are mistaken. Guests want to be believed long before they want to be compensated.' },
    ],
  },
];
...
const complaintsLessons: Lesson[] = [
  {
    ...
    quiz: [
      ...
      { q: 'A guest complains about their meal. According to the Service Recovery Paradox, what\'s possible if you handle it brilliantly?', options: ['They will leave a negative review no matter what', 'You can only hope they forgive you', 'They will probably never return regardless', 'They can become MORE loyal than guests who never had a problem'], correct: 3, explain: 'The Service Recovery Paradox is real — a brilliantly handled complaint creates stronger loyalty than a flawless experience. The emotional impact of being truly heard and helped is that powerful.' },
      { q: 'What does it mean when a guest chooses to complain instead of leaving?', options: ['They are giving you a second chance — they still believe in you', 'They want compensation', 'They are testing your patience', 'They are difficult and demanding'], correct: 0, explain: 'A complaining guest is a loyal guest in waiting. They chose to speak up instead of walking out. That\'s a gift.' },
      ...
      { q: 'What matters MORE in service recovery?', options: ['Involving a manager immediately', 'The size of the compensation offered', 'Speed — how quickly the problem is resolved', 'A detailed explanation of what went wrong'], correct: 2, explain: 'Speed of recovery is the single biggest factor in guest satisfaction after a complaint. A fast, genuine fix beats a slow perfect one every time.' },
    ],
  },
  {
    id: 'learn-protocol',
    ...
    quiz: [
      { q: 'A guest is explaining their complaint. You realize you know exactly what happened and how to fix it. What do you do?', options: ['Start walking toward the kitchen to fix it while they talk', 'Nod and say "yes yes I know"', 'Interrupt politely and offer the solution — saves time', 'Let them finish speaking completely before responding'], correct: 3, explain: 'Never interrupt. The most common mistake in complaint handling is jumping to a solution before the guest finishes. They need to feel completely heard first.' },
      { q: 'What\'s the difference between empathy and sympathy in complaint handling?', options: ['Empathy acknowledges their feelings; sympathy just acknowledges the facts', 'Sympathy is more professional', 'Empathy is only for serious complaints', 'Nothing — they mean the same thing'], correct: 0, explain: '"I understand there was a problem" is sympathy — facts only. "I understand how frustrating that must have been" is empathy — feelings first. Guests need to feel understood, not just processed.' },
      { q: 'A guest complains their food was cold. Which apology is correct?', options: ['"I\'m sorry but we\'ve been very busy tonight"', '"I\'m sorry — that\'s not acceptable and I\'m going to fix it right now"', '"I apologize but it was hot when it left the kitchen"', '"I\'m sorry you feel that way"'], correct: 1, explain: 'The apology must be direct and unconditional. No excuses, no blame-shifting. "I\'m sorry you feel that way" is not an apology — it dismisses their experience.' },
      { q: 'After resolving a complaint, what must you always do?', options: ['Inform the manager immediately', 'Thank the guest for their patience and move on', 'Follow up to confirm they\'re satisfied', 'Let them enjoy their meal without further interruption'], correct: 2, explain: 'The N in LEARN is Notify — always follow up. Most staff resolve and disappear. The follow-up is what converts a recovered guest into a loyal one.' },
      { q: 'A guest is still unhappy after your resolution attempt. What now?', options: ['Offer more and more compensation until they\'re happy', 'Explain the situation more clearly', 'Apologize again and walk away', 'Escalate to a manager — some situations need more authority than you hold'], correct: 3, explain: 'Know when to escalate. You are empowered to resolve most situations — but if a guest remains upset after your best effort, a manager must step in. Escalation is not failure — it\'s professionalism.' },
    ],
  },
  {
    ...
    quiz: [
      { q: 'A guest says "We\'ve been waiting 40 minutes." Which response is correct?', options: ['"I\'m so sorry for the wait — that\'s too long. Let me check right now and be back in two minutes. Can I bring you something while you wait?"', '"40 minutes isn\'t unusual on a busy night."', '"I\'ll go find out what happened."', '"The kitchen is really busy tonight."'], correct: 0, explain: 'Acknowledge the wait specifically, never make excuses, give a concrete timeline, and offer something. The kitchen being busy is your problem — not theirs.' },
      ...
      { q: 'A guest says "This isn\'t what I ordered." What should you NEVER say?', options: ['"I sincerely apologize for the confusion."', '"I\'m so sorry — what did you order? I\'ll fix this right away."', '"Are you sure? Let me check what you ordered."', '"Let me get the correct dish out as quickly as possible."'], correct: 2, explain: 'Never question the guest. "Are you sure?" is the most damaging phrase in complaint handling — it shifts blame onto the guest and signals you don\'t believe them. Own it and fix it.' },
      { q: 'A guest questions a charge on the bill. The correct response is:', options: ['"Our billing is always accurate."', '"You\'ll need to speak with the manager about billing."', '"That\'s what our system shows."', '"Let me take a look at this right away. If there\'s an error, we\'ll correct it immediately."'], correct: 3, explain: 'Never argue. Look at it together. Fix any error immediately and apologize. "That\'s what our system shows" dismisses the guest and invites a confrontation.' },
      { q: 'A guest says "This doesn\'t taste right — it seems off." You say:', options: ['"Thank you for telling me — I\'ll take this back right away and bring you something fresh. I\'m sorry."', '"Can you describe what\'s wrong with it?"', '"Let me check with the kitchen to confirm."', '"That\'s how it\'s supposed to taste."'], correct: 0, explain: 'Never argue about taste. If a guest says something is wrong, believe them and act. "That\'s how it\'s supposed to taste" is the most dismissive response in hospitality.' },
    ],
  },
  {
    id: 'prevention',
    ...
    quiz: [
      ...
      { q: 'Which check-in phrase prevents 90% of complaints from escalating?', options: ['"Did you enjoy it?"', '"Is everything okay?"', '"How are you finding the flavors? Is the temperature right on the dish?"', '"Everything good over here?"'], correct: 2, explain: '"Is everything okay?" invites a yes/no answer. "How are you finding the flavors?" invites a real conversation and catches problems before they become complaints.' },
      { q: 'A ticket has been sitting for 20 minutes with no update. You should:', options: ['Tell the table only if they complain about the wait', 'Ask your manager to handle the communication', 'Wait for the kitchen to let you know when it\'s ready', 'Proactively update the table before they have to ask'], correct: 3, explain: 'Order taking more than 20 minutes is a warning sign. Communicate to the table proactively — tell them before they have to ask. This converts a potential complaint into a trust moment.' },
      { q: 'A guest keeps glancing at their watch during dinner. This signals:', options: ['They may be on a schedule — offer to move the pace along proactively', 'They\'re just a nervous person', 'Nothing specific — it\'s a habit', 'They\'re bored with their companion'], correct: 0, explain: 'A glance at the watch is a signal. Offer to help before they have to ask: "I can have your next course out in about 8 minutes if that helps." Anticipation turns a potential complaint into a 5-star moment.' },
...
const guestPsychologyLessons: Lesson[] = [
  {
    ...
    quiz: [
      { q: 'A couple is seated, speaking softly, clearly on a date night. They haven\'t looked up from their conversation. You approach. What do you do?', options: ['Ask immediately if they\'re celebrating anything', 'Greet them loudly and enthusiastically to set the energy', 'Approach softly, make eye contact, and wait for a natural pause before speaking', 'Leave them completely alone until they wave at you'], correct: 2, explain: 'Romantic couples want presence without interruption. The nod-and-wait is the five-star move — you show you\'re there without breaking their moment.' },
      { q: 'A group of 6 friends is celebrating a birthday — loud, laughing, taking photos. Your service approach should be:', options: ['Quick and efficient — they\'re loud enough without you adding to it', 'Quieter than usual to balance their energy', 'Formal and professional — keep it polished and efficient', 'Match their energy — warm, playful, engage with the celebration'], correct: 3, explain: 'Groups want energy matched. A stiff or over-efficient approach at a birthday table kills the vibe. Match their enthusiasm while keeping service smooth.' },
      { q: 'A solo traveler sits down and looks around with curiosity. Best opening?', options: ['"Welcome — first time here? I have a recommendation most guests love"', '"What would you like to order?"', '"Table for one?"', '"Sitting alone tonight?"'], correct: 0, explain: 'Solo travelers respond powerfully to being made to feel like a local. A genuine recommendation plus "first time here?" opens a relationship and turns a solo meal into a discovery.' },
      ...
      { q: 'A couple you recognize walks in and moves confidently to their usual table. Best move?', options: ['Ask if they have a reservation as usual', 'Standard greeting — treat everyone equally', 'Acknowledge them by name if you know it and reference their last visit or usual preference', 'Let them settle in and approach after a few minutes'], correct: 2, explain: 'Recognition is the most powerful tool in hospitality. Regulars chose to come back — acknowledge that. A name plus a personal reference creates loyalty that no discount can match.' },
    ],
  },
  {
    ...
    quiz: [
      { q: 'A Dutch couple walks in — direct, efficient, dressed well. Best opening?', options: ['Silent and formal — let them lead entirely', '"Bon biní — how are you my friends?"', 'Loud and enthusiastic: "Welcome, so great to have you here tonight!!"', '"Welkom! Fijn dat u er bent — tafel voor twee?"'], correct: 3, explain: 'Dutch guests appreciate a clean, professional greeting in their own language. Not over-the-top — competence over charm. A Dutch greeting signals respect and immediately raises warmth.' },
      { q: 'A Venezuelan family arrives — animated, in no rush, speaking Spanish. Best service approach?', options: ['Warm, personal, ask how they\'re doing and mean it — the relationship matters as much as the food', 'Minimal interaction until they order', 'Extra-loud enthusiasm to match their energy', 'Efficient and fast — get them seated and ordered as quickly as possible'], correct: 0, explain: 'Latin American guests want to feel like family. Slow down. Ask and listen. The relationship you build in the first 2 minutes will shape their entire experience.' },
      ...
      { q: 'What is the universal rule of cultural awareness in hospitality?', options: ['Let guests set the pace entirely before deciding how to approach them', 'Adjust your service standards based on the guest\'s cultural expectations', 'Adjust your approach and style — never your service standards', 'Serve all guests identically regardless of cultural cues'], correct: 2, explain: 'Service quality is non-negotiable and identical for every guest. Only the style adapts — the warmth, the communication approach, the pace. The standard never changes.' },
      { q: 'A local Curaçaoan walks in for the first time. What makes the biggest immediate difference?', options: ['"Welcome to [Property]!" delivered with genuine warmth', 'Asking what they\'d like and getting straight to business', 'A standard English greeting with a warm smile', 'Even a simple "Bon biní" in Papiamentu signals recognition and belonging'], correct: 3, explain: 'Papiamentu from a non-local earns immediate warmth and trust. It says: "You are home here." Locals will appreciate the effort — and often help you improve. One word changes the entire dynamic.' },
    ],
  },
  {
    id: 'vip-guests',
    ...
    quiz: [
      { q: 'A guest returns for the third time this month. You recognize them. Best first move?', options: ['"Welcome back — it\'s great to see you again" using their name if you know it', 'Just nod and take their usual order', 'Ask if they have a reservation as usual', 'Standard greeting — treat everyone equally out of respect'], correct: 0, explain: 'Recognition is the whole game. A returning guest chose to come back — acknowledge that explicitly. Treating them like a new guest is a missed loyalty moment every single time.' },
      ...
      { q: 'A regular guest always orders the same coffee to start. They sit down. What do you do?', options: ['Only do this if a manager specifically instructs you to', 'Wait for them to order — presuming their drink could feel invasive', '"Your usual espresso — or would you like to try something different tonight?" and bring it', 'Ask what they\'d like as you would any new guest'], correct: 2, explain: 'Anticipating a regular\'s preference and naming it is one of the highest-impact moves in hospitality. "Or would you like something different" keeps it as an offer, not a presumption.' },
      { q: 'A VIP guest is leaving after a great meal. The ideal farewell includes:', options: ['Handing them a loyalty card or discount for next time', 'Just a warm smile — they know you appreciate them', 'A quick "thank you, have a great night"', 'A genuine, personal farewell using their name, referencing something from their visit, with a specific invitation to return'], correct: 3, explain: 'The close is the last thing they\'ll remember. Recency bias makes the departure as powerful as the arrival. Use their name, reference the evening specifically, and make the invitation to return feel personal.' },
      { q: 'How many times during a meal should you use a guest\'s name?', options: ['Approximately three times: arrival, once mid-meal, and at departure', 'Only at arrival — after that it can feel forced', 'Only if they introduce themselves first', 'As many times as possible to build connection'], correct: 0, explain: 'Three times: arrival, mid-meal, departure. Using a name too often feels transactional — like a call center script. Used at the right moments, it creates genuine personal connection.' },
    ],
  },
  {
    id: 'buying-signals',
    ...
    quiz: [
      ...
      { q: 'Which is the correct upselling formula?', options: ['Price comparison + portion size', 'Item name + price', 'Recommendation + reason + social proof', 'Menu description + alternative option'], correct: 2, explain: '"I\'d go with the X — it\'s [what makes it special] and it\'s one of our most popular." Star + reason + social proof. Every effective upsell follows this structure.' },
      { q: 'A business guest orders quickly with their menu closed. You should:', options: ['Offer the wine list before taking the order', 'Ask if they\'re sure about their choice', 'Upsell a starter and dessert — every table is an opportunity', 'Confirm their order accurately and process it efficiently — they\'re not open to suggestions'], correct: 3, explain: 'Reading the signal correctly means knowing when NOT to upsell. A closed menu and a quick order means decided and in a hurry. Accuracy and speed are what this guest needs — not a recommendation.' },
      { q: '"The dish pairs really beautifully with [wine] — a lot of guests order them together." This is:', options: ['A natural upsell: recommendation + reason + social proof working together', 'A scripted phrase that sounds inauthentic', 'An unnecessary interruption to the ordering moment', 'An aggressive upsell that will make guests feel pressured'], correct: 0, explain: 'This is the formula at work. A pairing suggestion with a reason and social proof doesn\'t feel like an upsell — it feels like genuine expertise. The guest feels helped, not sold to.' },
  ...
  },
  {
    ...
    quiz: [
      { q: 'The last thing a guest experiences is disproportionately powerful in shaping their overall memory. This is called:', options: ['Emotional anchoring', 'The halo effect', 'Recency bias', 'Peak performance syndrome'], correct: 2, explain: 'Recency bias means guests remember the end of an experience more vividly than the middle. A warm, personal close can rescue an average meal — and a cold goodbye can ruin a great one.' },
      { q: 'During the ordering stage, a guest asks for a recommendation. This is:', options: ['An opportunity to recommend the most profitable item', 'A sign they haven\'t read the menu properly', 'A simple transaction — tell them what\'s most popular', 'A trust moment — they\'re placing confidence in you. A great recommendation builds loyalty beyond the meal.'], correct: 3, explain: 'When a guest asks for a recommendation, they\'re offering you their trust. Respond with genuine expertise and a confident suggestion. This moment builds loyalty that outlasts the meal.' },
      { q: 'What is your goal during "the experience" stage — when guests are eating and relaxed?', options: ['Be invisible but present — notice without hovering, refill without asking', 'Leave guests completely alone — they have everything they need', 'Focus on clearing and resetting tables efficiently', 'Check in frequently to demonstrate attentiveness'], correct: 0, explain: '"Invisible but present" is the highest service standard. The guest should never feel ignored — but also never feel watched or interrupted. Anticipate needs silently.' },
      ...
      { q: 'A couple arrives having been told by a friend that this place is exceptional. Their emotional state is:', options: ['Competitive — comparing everything to what their friend described', 'Neutral — they\'ll judge entirely on their own experience', 'Anticipation with high expectations — you must exceed what they\'ve been told, not just match it', 'Skeptical — they\'ve heard recommendations before'], correct: 2, explain: 'A recommendation raises expectations. The anticipation stage is already active before they walk in. Your arrival moment must confirm and exceed what they\'ve been told — from the very first second.' },
    ],
  },
];
...
const casualDiningStandardLessons: Lesson[] = [
  {
    ...
    quiz: [
      { q: 'When does your first impression on a guest actually begin?', options: ['Only once you take their order.', 'When you drop the bill at the end.', 'The moment you greet them at the table.', 'Before you say a word — through your appearance and the energy you carry.'], correct: 3, explain: 'Guests read your confidence and care in the first glance. The impression is set long before any greeting — which is why showing up right matters.' },
      { q: 'You had a stressful morning and your shift is about to start. What\'s the professional move?', options: ['Take a breath at the door and switch into "service mode" — the stress stays behind.', 'Work quietly in the back until your mood improves.', 'Let the guests know you\'re having a rough day so they\'re understanding.', 'Carry the stress onto the floor — authenticity matters more than performance.'], correct: 0, explain: 'Guests didn\'t cause your bad day and shouldn\'t feel it. A small ritual at the door lets you leave personal stress behind and show up present.' },
      ...
      { q: 'Why does posture and body language matter so much on a casual dining floor?', options: ['Because managers grade you on how you stand.', 'Because it\'s required for the dress code only.', 'It doesn\'t — only the food and speed matter.', 'Because the room is open and fast, so guests constantly read your slouch, crossed arms, or avoided eye contact.'], correct: 3, explain: 'In an open, fast room there\'s nowhere to hide. Slouching, crossed arms, and avoided eye contact all send messages to guests — usually the wrong ones.' },
    ],
  },
  {
    ...
    quiz: [
      { q: 'Why does teamwork matter even more in casual dining than fine dining?', options: ['The pace is higher and the margin for error is smaller, so one person dropping the ball affects everyone.', 'Because casual dining has more managers watching.', 'Because casual dining guests tip individually, not by section.', 'It doesn\'t — fine dining needs more coordination.'], correct: 0, explain: 'Higher pace, faster tickets, and less support staff mean a single dropped ball lands on the whole floor — and on everyone\'s shared tips.' },
      { q: 'You spot an empty water glass at a table that isn\'t in your section. What does the team standard say?', options: ['Find that server and tell them about it.', 'If you see it, own it — refill it yourself.', 'Wait to see if the guest flags someone.', 'Leave it — it\'s the other server\'s responsibility.'], correct: 1, explain: '"If you see it, own it" is the first rule of floor teamwork. Help the guest first; section boundaries come second.' },
      { q: 'You need to step outside for a quick break during service. What should you do first?', options: ['Leave a note on the host stand.', 'Just go — you\'ll only be a minute.', 'Tell a colleague so your tables are covered while you\'re gone.', 'Wait until every one of your tables is completely settled, even if it takes 30 minutes.'], correct: 2, explain: '"Communicate before you disappear" keeps tables covered. A teammate can\'t cover for you if they don\'t know you\'re gone.' },
      { q: 'Table 6 has waited 20 minutes for their food during a rush. What\'s the best way to raise it with the kitchen?', options: ['Tell the guest the kitchen is too slow today.', '"What is taking so long with table 6?!"', 'Say nothing and hope it comes up soon.', 'Calmly: "Table 6 has been waiting 20 minutes — can we prioritize them?"'], correct: 3, explain: 'Flag issues calmly and early with facts, not blame. A server the kitchen trusts gets their tickets handled; conflict only slows things down.' },
      { q: 'A colleague\'s section just got slammed with six new tables. What\'s the right way to step in?', options: ['Catch their eye, ask "what do you need?", and take one concrete task off their plate.', 'Tell a manager their section is too busy.', 'Take over their tables entirely so they can catch up.', 'Ignore it — it\'s their section and their tips.'], correct: 0, explain: 'Stepping in without stepping on toes means asking what they need and handling one thing — running drinks, dropping bread — not seizing their section.' },
    ],
  },
  {
    ...
    quiz: [
      ...
      { q: 'A guest says they have a peanut allergy. What\'s the correct sequence?', options: ['Just avoid the obvious peanut dishes and serve the rest.', 'Tell them to ask the kitchen themselves.', 'Assume the kitchen knows and put the order in normally.', 'Confirm severity with the guest, flag the ticket clearly to the kitchen, never assume, and reconfirm when delivering.'], correct: 3, explain: 'Confirm, flag clearly, never assume, and reconfirm at delivery. An allergy is never a place to guess or cut a corner.' },
      { q: 'Do guests always tell you about their allergies up front?', options: ['No — they may not volunteer it, so you should ask.', 'Only guests with severe allergies mention it.', 'It\'s not your job to ask; wait for them to say.', 'Yes — they always mention it when ordering.'], correct: 0, explain: 'Guests don\'t always volunteer an allergy. Asking is part of protecting them — never assume silence means no allergy.' },
  ...
  },
  {
    ...
    quiz: [
      { q: 'What\'s the difference between being fast and making a guest feel rushed?', options: ['Feeling rushed means the server is working hard, which guests appreciate.', 'There is no difference — fast always feels rushed.', 'Efficiency done right is invisible; the guest feels relaxed even while you move at double speed.', 'Rushing is good when the restaurant is busy.'], correct: 2, explain: 'Great efficiency is invisible to the guest. They should feel unhurried and cared for, never like you\'re trying to turn their table.' },
      { q: 'During a rush, what sits at the top of the priority ladder?', options: ['Resetting empty tables for the next guests.', 'Restocking and side work.', 'Clearing finished plates from every table.', 'Hot food that\'s ready in the kitchen.'], correct: 3, explain: 'Ready food is the top priority — hot plates die under the heat lamp. Run them first, then refills, check-ins, clearing, and everything else.' },
      { q: 'How is attention to detail a "speed multiplier"?', options: ['Catching things early means fewer interruptions, fewer return trips, and fewer waiting guests.', 'It only matters in fine dining, not casual.', 'It just makes managers happy during reviews.', 'It isn\'t — paying attention slows you down.'], correct: 0, explain: 'Seeing the near-empty glass or the searching guest before they signal removes work before it appears — that\'s what makes sharp servers seem effortlessly fast.' },
      { q: 'The pass is clear and no food is waiting. What comes next on the priority ladder?', options: ['Whichever table happens to be nearest to where you are standing.', 'Drink refills — an empty glass is the clearest sign of neglect.', 'Side work and restocking, while you have a quiet moment to do it.', 'Resetting the empty tables so the next seating can be sat down.'], correct: 1, explain: 'The ladder runs: ready food, then refills, then check-ins on tables that have been waiting, then clearing, and side work last. Side work matters, but it never comes before a guest.' },
      { q: 'A guest at your table keeps glancing around the room. What does an attentive server read from this?', options: ['They want the bill, so bring it without asking.', 'Nothing — they\'re just looking at the décor.', 'They need something and shouldn\'t have to wave you down — go check in.', 'They\'re bored and will leave soon.'], correct: 2, explain: 'A guest scanning the room is a signal you catch before they have to flag you. Anticipating it is exactly how you stay ahead and avoid the wave.' },
    ],
  },
];
...
const casualDiningFloorLessons: Lesson[] = [
  {
    ...
    quiz: [
      { q: 'What is taking an order correctly actually about?', options: ['Memorizing everything so you don\'t need to write it down.', 'Getting through it quickly so you can move to the next table.', 'Writing as fast as possible to save time.', 'Giving the table full attention, getting every detail right, and confirming before you leave.'], correct: 3, explain: 'Accuracy beats speed. Full attention for sixty seconds and a read-back before you walk away is what makes the rest of the meal flow.' },
      { q: 'A guest changes their dish — dressing on the side, greens instead of rice. What\'s the right move?', options: ['Write it down and repeat the change back as you note it.', 'Tell them modifications slow the kitchen down.', 'Note only the part you think matters most.', 'Say "sure" and trust yourself to remember it.'], correct: 0, explain: 'Capture the modification the moment it\'s said and read it back. A vague "sure" you hope to remember is how the wrong plate reaches the table.' },
      ...
      { q: 'Why read the full order back before leaving the table?', options: ['It shows the guests how good your memory is.', 'It fills time while the guests settle.', 'It\'s the fastest way to catch a mistake before it becomes a remade plate and a table that doesn\'t trust you.', 'It\'s only necessary for large groups.'], correct: 2, explain: 'Thirty seconds of read-back saves ten minutes of remade food. It catches errors while they\'re still free to fix.' },
      { q: 'At a four-top with mixed modifications, what separates the professional from the amateur?', options: ['The professional takes the orders faster.', 'The professional lets the kitchen sort out the modifications.', 'The professional holds it all in their head to look impressive.', 'The professional writes each order down as it\'s said, asks the follow-up questions, notes the allergy clearly, and reads the whole table back.'], correct: 3, explain: 'Writing each item down in the moment, asking cook-temp and side questions, flagging the allergy, and confirming the full order is exactly how the pro avoids a wrong plate.' },
    ],
  },
  {
    ...
    quiz: [
      { q: 'What does "section awareness" actually mean?', options: ['Holding the live status of every table in your head at once — who just sat, who ordered, who\'s waiting, who\'s eating, who needs the bill.', 'Watching your manager\'s section as well as your own.', 'Remembering which tables tip the best.', 'Knowing how many tables are in your section.'], correct: 0, explain: 'Section awareness is the mental map of every table\'s state at once. It\'s what lets you stay ahead instead of reacting to whoever waves loudest.' },
      { q: 'Three tables need you at the same time. How do you decide what comes first?', options: ['Serve whoever is waving or calling loudest.', 'Triage by impact — ready hot food first, then a new ungreeted table, then quick needs like a refill or bill.', 'Handle them strictly in the order they sat down.', 'Serve whoever is closest to you.'], correct: 1, explain: 'Triage by impact, not volume. Hot food dies under the lamp and an ungreeted guest sours fastest — those come before a quick refill that can wait thirty seconds.' },
      { q: 'Which table state is the "danger zone" where guests most often feel forgotten?', options: ['Ready for the bill.', 'Just seated.', 'Waiting on food.', 'Eating.'], correct: 2, explain: 'Waiting on food is where guests feel forgotten. Keeping them seen during that stretch is what prevents frustration before it starts.' },
      { q: 'You\'re slammed and stretched thin. What\'s the right way to handle a waiting guest?', options: ['Apologize repeatedly every time you pass.', 'Avoid eye contact until you can actually help them.', 'Explain how busy you are so they understand.', 'Acknowledge the wait warmly, set a realistic expectation, and never let your stress show.'], correct: 3, explain: 'Guests forgive busy; they don\'t forgive feeling forgotten. Honest acknowledgment, a realistic time, and calm composure keep them patient — excuses and over-apologizing don\'t.' },
      { q: 'You\'re crossing the floor to grab one drink refill. What does an aware server do?', options: ['Batch it — check the mental map and carry or clear whatever else is on the way.', 'Wait until several tables need things before moving.', 'Ask another server to cover the trip.', 'Make the single trip — focus on one task at a time.'], correct: 0, explain: 'Never cross the floor for one thing. Batching trips off your mental map is what keeps a stretched section moving without double-backs.' },
    ],
  },
  {
    id: 'table-turns',
    ...
    quiz: [
      ...
      { q: 'A guest lays their cutlery together on the plate. What does this signal?', options: ['They want to be left alone.', 'They want more food.', 'They\'re finished with the course — clear the table together once the last guest signals.', 'They\'re unhappy with the dish.'], correct: 2, explain: 'Cutlery laid together is the universal "I\'m done" signal. Wait for the last guest at the table to show it, then clear all the plates together in the next natural pause — never while someone is still eating.' },
      { q: 'What\'s the right way to present the bill when a table is winding down?', options: ['Tell them you need the table for the next party.', 'Drop it silently and walk away fast.', 'Wait until they explicitly ask for it.', 'Present it warmly with no pressure — "whenever you\'re ready, no rush at all."'], correct: 3, explain: 'Present at the natural lull, framed with zero pressure. It nudges the table toward its close without a single word that sounds like "hurry up."' },
      { q: 'Which of these rushes a guest the loudest — even without words?', options: ['Hovering nearby, sighing, or stacking chairs close to the table.', 'Closing with a warm invitation back.', 'Pre-bussing empty plates as you pass.', 'Offering dessert at a natural lull.'], correct: 0, explain: 'Body language rushes guests louder than words. Hovering, sighing, and stacking chairs nearby all scream "hurry up" even if you never say it.' },
  ...
  },
  {
    ...
    quiz: [
      ...
      { q: 'What is the "scan," and how often should you do it?', options: ['A once-per-shift review with your manager.', 'A check you do only when a table flags you.', 'A quick check of your phone between tables.', 'A sweep of your whole section — glasses, plates, faces — done every single time you pass through it.'], correct: 3, explain: 'The scan is a one-pass sweep of glass levels, plate states, and body language, done every time you cross your section. Making it automatic is how great servers seem to have eyes everywhere.' },
      { q: 'What does the "one-trip rule" (never walking empty-handed) mean?', options: ['Every trip out of the kitchen carries something to the floor, and every trip back brings something with it.', 'Never carry more than one plate at a time for safety.', 'Limit yourself to one lap of the floor between orders.', 'Only make one trip to each table per visit.'], correct: 0, explain: 'Never walking empty-handed means each trip in either direction is doing work — delivering, clearing, or grabbing what you spotted was needed. It erases return trips.' },
      ...
      { q: 'Why is the observant regular the ultimate test of efficiency and attention?', options: ['Because they prefer slower, more formal service.', 'Because they always tip the most.', 'Because they read your section the way you should — they see the glass you didn\'t refill and the plate you left, so you can only out-attention them, not charm them.', 'Because they expect free items for being loyal.'], correct: 2, explain: 'A sharp regular notices every detail you miss. The only way to win them is to anticipate everything smoothly — and when service feels effortless to them, that\'s the highest compliment there is.' },
    ],
  },
];
...
const fineDiningStandardLessons: Lesson[] = [
  {
    ...
    quiz: [
      { q: 'What is fine dining fundamentally about?', options: ['Serving food as quickly and efficiently as possible.', 'Impressing guests with expensive ingredients.', 'Being formal, stiff, and following strict rules.', 'Making guests feel genuinely and deeply cared for.'], correct: 3, explain: 'Fine dining is not about stiffness or formality — it is about making guests feel cared for at a level they rarely experience.' },
      { q: 'What is the difference between service and hospitality?', options: ['Service is delivering food and drink; hospitality is making the guest feel seen, valued, and cared for.', 'Hospitality is faster; service is slower.', 'Service is for fine dining; hospitality is for casual dining.', 'There is no difference — they mean the same thing.'], correct: 0, explain: 'Service delivers food and drink. Hospitality makes the guest feel cared for — and fine dining demands hospitality, not just service.' },
      ...
      { q: 'What does it mean that "calm is a skill"?', options: ['Calm only matters when the restaurant is quiet.', 'Calm is a personality trait you either have or you don\'t.', 'Calm is something you perform under pressure until it becomes natural — you never let pressure reach the guest.', 'Calm means working slowly so you never feel rushed.'], correct: 2, explain: 'Pressure is constant in a busy service. Calm is not a feeling you wait for — it is something you perform, so the pressure never reaches the guest.' },
      { q: 'Which of these is one of the four principles of the fine dining mindset?', options: ['Telling guests when the kitchen is running slow.', 'Keeping every conversation casual and relaxed.', 'Speed above all else.', 'Pride in craft — treating the work as a craft, not just a job.'], correct: 3, explain: 'Pride in craft is one of the four principles. The best fine dining servers carry the work as a craft, not just a job.' },
    ],
  },
  {
    ...
    quiz: [
      { q: 'Why does the lesson say you are "always on stage" in a fine dining room?', options: ['Because a guest anywhere in the room can see how you carry yourself and read your energy.', 'Because there are cameras on the floor.', 'Because you have to perform a fixed script for guests.', 'Because managers are always watching you.'], correct: 0, explain: 'In an open dining room a guest at the far end can see your posture, pace, and expression. Your presence communicates your standard before you speak.' },
      { q: 'What is the right pace to move through the dining room?', options: ['Slow and relaxed so you never seem busy.', 'Calm and purposeful — never rushing, because rushing communicates chaos.', 'Whatever pace matches how busy you feel inside.', 'As fast as possible to serve more tables.'], correct: 1, explain: 'Walk at a calm, purposeful pace — not slow, but never rushed. If you genuinely need to move fast, do it through the kitchen, not the dining room.' },
      { q: 'You need to hurry to the kitchen during a busy service. What\'s the right move?', options: ['Stop serving until the rush passes.', 'Rush straight across the dining room — guests understand busy.', 'Move fast through the kitchen, not visibly through the dining room.', 'Jog between tables while apologizing as you go.'], correct: 2, explain: 'Rushing through the dining room communicates chaos. If you must move quickly, route through the kitchen so the floor stays calm.' },
      { q: 'What does the lesson say about your hands while on the floor?', options: ['Use them constantly to gesture so you seem warm.', 'Keep them in your pockets so you look relaxed.', 'Cross your arms while waiting so you look composed.', 'Keep them out of pockets — at your sides, behind your back, or carrying something.'], correct: 3, explain: 'Hands stay out of pockets at all times — at your sides, behind your back, or carrying something. Never crossed arms, never fiddling.' },
      { q: 'You\'ve just had a stressful table and you\'re tense. How do you manage your presence?', options: ['Drop your shoulders, slow your pace slightly, reset your face — and take 20 seconds in the kitchen if you can.', 'Vent quickly to a colleague on the floor to release it.', 'Carry on at the same fast pace so you don\'t fall behind.', 'Let the guests see you\'re stressed so they\'re patient with you.'], correct: 0, explain: 'Reset your presence deliberately: drop your shoulders, slow down a touch, reset your expression, and decompress in the kitchen — never on the floor.' },
    ],
  },
  {
    ...
    quiz: [
      ...
      { q: 'What does the lesson say about scent in fine dining?', options: ['Scent doesn\'t matter as long as you\'re clean.', 'Only the kitchen staff need to avoid strong scent.', 'Wear a strong signature cologne so you\'re memorable.', 'No strong perfume, cologne, or deodorant — strong scent interferes with the aroma of food and wine.'], correct: 3, explain: 'Guests are eating and drinking, so strong scent interferes with the aroma of food and wine. Subtle is professional.' },
      { q: 'When should your uniform be pressed and your shoes polished?', options: ['Before you arrive — ready before the shift briefing.', 'Only on busy nights.', 'Whenever you find a spare moment during service.', 'During pre-service prep time once you arrive.'], correct: 0, explain: 'Arrive already presentable. Ironing or fixing your uniform during prep time means you showed up unready.' },
  ...
  },
  {
    ...
    quiz: [
      { q: 'Guests can\'t see what happens between staff. So why does teamwork matter so much?', options: ['It matters only when the restaurant is busy.', 'It doesn\'t affect guests, since they can\'t see it.', 'Guests feel the team\'s coordination and tension even when they can\'t name it.', 'It only matters for the staff\'s own comfort.'], correct: 2, explain: 'Guests sense a poorly coordinated or tense team even without seeing it. A great team is invisible: seamless, coordinated, and composed.' },
      { q: 'A colleague\'s guest is looking around for water and you\'re passing by. What does fine dining teamwork say?', options: ['Wait to see if the guest flags someone down.', 'Find that colleague and tell them their table needs water.', 'Ignore it — it\'s not your table.', 'Cover it yourself — refill the water without waiting to be asked.'], correct: 3, explain: 'Cover without being asked. If you see a colleague\'s table needs something, you handle it — you don\'t wait to be asked.' },
      { q: 'Something goes wrong during service. What\'s the only relevant question in the moment?', options: ['What do we do right now?', 'Who should we tell about it?', 'Whose fault was it?', 'How did this happen?'], correct: 0, explain: 'Fine dining professionals fix first and debrief later. In the moment, the only question that matters is what to do right now — not blame.' },
...
const fineDiningPresenceLessons: Lesson[] = [
  {
    ...
    quiz: [
      { q: 'According to the standard, when does a guest decide how cared for they feel?', options: ['Only when you present the bill.', 'When they read the online reviews beforehand.', 'Once they have tasted the first course.', 'From the way you carry yourself, before you say a single word.'], correct: 3, explain: 'Your body language communicates care in the silence before words. A guest reads how you move and stand long before you speak.' },
      { q: 'What is the correct way to approach a fine dining table?', options: ['Unhurried, on a slight angle, stopping at a respectful distance.', 'From directly behind, to surprise them pleasantly.', 'As close as possible so they can hear you over the room.', 'Quickly and head-on, so the guest knows you are attentive.'], correct: 0, explain: 'A measured approach on a slight angle, stopping at a respectful distance, signals full attention without looming over the table.' },
      ...
      { q: 'A guest at another table catches your eye while your hands are full. What do you do?', options: ['Call across the room that you will be there shortly.', 'Look away — you can\'t help them right now anyway.', 'Meet their eye with a small, warm nod that says "I see you, I am coming."', 'Rush over immediately and abandon what you are carrying.'], correct: 2, explain: 'A guest who feels seen waits calmly. A small nod acknowledges them silently; a guest who feels invisible grows restless within seconds.' },
      { q: 'Why does quick, darting movement work against you on the floor?', options: ['It is only a problem if a guest mentions it.', 'It tires you out before the end of service.', 'It doesn\'t — fast movement shows the guests you are working hard.', 'It reads as anxiety and ripples through the room, undermining the sense of calm.'], correct: 3, explain: 'Calm, deliberate movement reassures the room. Darting, anxious movement signals chaos and quietly unsettles every guest who sees it.' },
    ],
  },
  {
    id: 'fdp-voice',
    ...
    quiz: [
      { q: 'Why does casual phrasing matter so much in a fine dining room?', options: ['Guests at this level notice language the way they notice a smudged glass; slang instantly drops the room a level.', 'It only matters with older guests.', 'It matters only when the manager is on the floor.', 'It doesn\'t — guests only care about the food.'], correct: 0, explain: 'Refined guests register language as keenly as any other detail. A casual phrase undermines the experience no matter how beautiful the plates are.' },
      ...
      { q: 'How should you manage your volume at the table?', options: ['Match the volume of the room around you.', 'Speak loudly so the whole party hears you clearly.', 'Soft enough that the next table can\'t follow, clear enough to be understood the first time.', 'As quietly as possible, even if guests must ask you to repeat.'], correct: 2, explain: 'The guest should feel they are in a private exchange, not a public announcement — soft but perfectly clear.' },
      { q: 'You are addressing a mixed table and want to ask the others what they would like. What is the refined approach?', options: ['"Anyone else want anything?"', '"You all good for now?"', '"What about you guys?"', 'Address each guest directly — "And for yourself, sir?" / "And for you, madam?"'], correct: 3, explain: 'Address guests directly and individually. "You guys" is exactly the casual habit fine dining language replaces.' },
      { q: 'Why do casual phrases tend to "slip out" even when you know better?', options: ['Because they are habits, not decisions — so they surface under pressure until you drill the replacement.', 'Because guests sometimes prefer them.', 'They don\'t — anyone can simply choose better words on the spot.', 'Because the refined versions are too long to say.'], correct: 0, explain: 'Slang is automatic, not chosen. Only practicing the refined version until it becomes your default retires it, even on the busiest night.' },
    ],
  },
  {
    id: 'fdp-approach',
    ...
    quiz: [
      ...
      { q: 'What is the "three-second read"?', options: ['A rule that you may only spend three seconds per table.', 'Counting to three before you speak at every table.', 'A glance from a step or two away to read whether the table is open or mid-moment before you commit to speaking.', 'The time it takes to recite the specials.'], correct: 2, explain: 'The three-second read happens at a glance before you arrive — are they mid-conversation, mid-toast, or open and ready?' },
      { q: 'A course is ready, but the table is mid-toast with glasses raised. What do you do?', options: ['Set it down quietly between them during the toast.', 'Ask them to pause their toast so you can serve.', 'Deliver it now — the kitchen\'s timing comes first.', 'Hold the plate one moment longer and let the toast finish.'], correct: 3, explain: 'A held plate is always better than a broken moment. The right timing protects the guest\'s experience over the kitchen\'s convenience.' },
      { q: 'The moment is genuinely wrong — an emotional, serious conversation. What is the move?', options: ['Hold a respectful step back, or withdraw smoothly and return shortly.', 'Hover at the edge of the table until they notice you.', 'Interrupt with an apology so they know you tried.', 'Push through gently; the service still has to happen.'], correct: 0, explain: 'When the moment is wrong, withdraw smoothly and return. Hovering or interrupting both break the moment you are trying to protect.' },
  ...
  },
  {
    ...
    quiz: [
      { q: 'What does "invisible service" actually mean?', options: ['Only approaching the table when a guest signals you.', 'Staying out of sight and letting guests fend for themselves.', 'Moving with such timing and economy that your care is felt everywhere and noticed nowhere.', 'Serving as quickly as possible to minimize contact.'], correct: 2, explain: 'Invisible service is care that is felt everywhere and noticed nowhere — the glass stays full and the table clear, yet the guest never sees you do it.' },
      { q: 'When should you clear a finished plate from a fine dining table?', options: ['Only once you have asked the table if they are finished.', 'At the end of the meal, all at once.', 'The instant the guest puts down their fork, mid-sentence if needed.', 'In the natural lull between conversational beats, quietly and from the right.'], correct: 3, explain: 'Clear in the gaps, not across them — wait for a natural pause and remove plates quietly without making the table stop to acknowledge you.' },
      { q: 'How should you handle water and wine refills invisibly?', options: ['Watch the line from across the room and top up before empty, from the side, without breaking the conversation.', 'Wait until a glass is completely empty so you don\'t over-pour.', 'Leave the bottle on the table for guests to pour themselves.', 'Ask "more water?" each time you pass so the guest stays in control.'], correct: 0, explain: 'Anticipate the refill and deliver it smoothly from the side, withdrawing without interrupting — the guest enjoys a full glass and never registers how.' },
      ...
      { q: 'A guest has to ask you for more bread. By the standard of invisible service, what does that tell you?', options: ['The kitchen should have sent more bread automatically.', 'Nothing — answering requests is the job.', 'You noticed the need too late; invisible service anticipates before the guest thinks to ask.', 'The guest is being demanding.'], correct: 2, explain: 'A need a guest has to voice is a need you noticed too late. Invisible service is built on anticipation, not reaction.' },
    ],
  },
];
...
const fineDiningEtiquetteLessons: Lesson[] = [
  {
    ...
    quiz: [
      { q: 'A guest has just sat down. What is the correct napkin service?', options: ['Shake it open over the table and drape it across the plate.', 'Wait until the first course arrives, then hand it to them.', 'Leave the napkin folded so they can place it themselves.', 'Step in from the right, open it smoothly, and lay it gently across their lap.'], correct: 3, explain: 'Once the guest is seated, open the napkin in one calm motion and lay it across the lap from the right. You place it for the guest — you do not leave them to handle it.' },
      { q: 'A guest stands up to leave the table during the meal. What do you do with their napkin?', options: ['Take it, fold it loosely or replace it, and set it to the left of the setting.', 'Drape it over the back of their chair.', 'Take it away until they return.', 'Leave it where it fell so you don\'t disturb their place.'], correct: 0, explain: 'When a guest steps away, fold or replace the napkin and set it neatly by the setting, ready for their return. Never leave it crumpled on the chair or table.' },
      { q: 'A guest drops their napkin on the floor. What is the correct response?', options: ['Leave it — pointing it out would embarrass them.', 'Quietly remove it and bring a fresh one without a word.', 'Ask the guest whether they would like a new one.', 'Pick it up and hand it straight back to them.'], correct: 1, explain: 'A dropped napkin never goes back. You remove it quietly and bring a fresh one without a word, so the guest never feels they caused a problem.' },
      ...
      { q: 'Why does the way you handle the napkin matter so much?', options: ['It only matters if the guest asks about it.', 'It matters only for hygiene.', 'It doesn\'t — only the food and wine service count.', 'It is the first thing you handle for the seated guest, so it sets the tone for the whole meal.'], correct: 3, explain: 'The napkin is the first thing you handle once a guest sits down. Handled with care, it quietly shows that the whole evening is in good hands.' },
    ],
  },
  {
    ...
    quiz: [
      { q: 'In what order are guests served at a fine dining table?', options: ['Ladies first, then gentlemen, then the host last.', 'The host first, as they are paying.', 'Oldest to youngest, nothing else.', 'Whoever is closest first, then around the table.'], correct: 0, explain: 'The order is ladies first, then gentlemen, then the host last. Serving the host last shows their guests were cared for before them.' },
      { q: 'From which side do you place plated food, and from which side do you clear?', options: ['Serve and clear both from the left.', 'Serve from the left, clear from the right.', 'Always from whichever side is closer.', 'Serve from the right, clear from the left.'], correct: 1, explain: 'Serve from the left, clear from the right. This way your arm never crosses in front of the guest.' },
      { q: 'Where do you pour wine and water from, and why?', options: ['From the right, after lifting the glass off the table.', 'From the left, to match the food service.', 'From the right, because the glasses sit to the upper right of the setting.', 'From wherever you can reach the glass most easily.'], correct: 2, explain: 'Glasses sit to the upper right of the setting, so water and wine are poured from the right — reaching the glass without lifting it from the table.' },
      { q: 'Why is reading the host called the skill "above the rules"?', options: ['Because only the host may ask for more wine.', 'Because the host must approve each course in person.', 'Because the host decides who sits where.', 'Because the host sets the pace of the meal, and a good server takes cues from them all through it.'], correct: 3, explain: 'The host sets the pace of the table. Reading their cues — a nod for more wine, a readiness for the next course — matters more than the fixed rules of service.' },
      { q: 'A guest is seated tight against a wall, so the correct side is impossible. What do you do?', options: ['Choose the side that avoids reaching across the guest, do it smoothly, and don\'t make it obvious.', 'Skip that guest and serve them last from any angle.', 'Reach across the guest quickly to keep the rule.', 'Insist on the correct side and ask the guest to move.'], correct: 0, explain: 'The rule — never reach across the guest — matters more than the side. When the setting won\'t allow the normal way, adapt smoothly so no one notices.' },
    ],
  },
  {
    ...
    quiz: [
      ...
      { q: 'Why should you never stack plates at the table?', options: ['Guests find it unhygienic.', 'It\'s faster to carry them one at a time anyway.', 'Scraping and stacking in front of guests turns fine service into clearing-up — it belongs out of sight.', 'Stacked plates break more easily.'], correct: 2, explain: 'Stacking and scraping at the table makes service look like clearing-up. Clear quietly and do the stacking and scraping out of the guest\'s sight.' },
      { q: 'What is wrong with asking "Are you still working on that?"', options: ['It\'s too formal for most guests.', 'It should be asked only of the host, not other guests.', 'Nothing — it\'s a perfectly polite way to check.', 'It makes the meal sound like a job and rushes the guest; "May I clear this for you?" makes it a courtesy.'], correct: 3, explain: '"Working on it" treats the meal as work and rushes the guest. "May I clear this for you?" keeps the moment a courtesy — the words you choose show your standard.' },
      { q: 'A guest makes a real complaint about their dish. What is the graceful response?', options: ['Listen fully, say sorry sincerely, take responsibility for the house, and fix it quietly and quickly.', 'Apologize again and again and hover until they\'re happy.', 'Offer a discount right away to close the matter.', 'Explain exactly why the kitchen made the mistake.'], correct: 0, explain: 'Listen, say sorry, take responsibility for the house, and put it right quietly — never interrupt, get defensive, or blame the kitchen or a colleague.' },
  ...
  },
  {
    ...
    quiz: [
      { q: 'A guest is unsure which fork to use first. What do you tell them?', options: ['Wait for you to hand them the right one each course.', 'Whichever feels most comfortable to them.', 'Work from the outside in — the outer cutlery is for the first course.', 'Always start with the fork nearest the plate.'], correct: 2, explain: 'Cutlery is used outside-in, one pair per course. A guest need only start at the outside, and you can tell them exactly that.' },
      { q: 'A guest\'s fork and knife are resting apart, angled open on the plate. What does this mean?', options: ['They want the next course right away.', 'They are unhappy with the dish.', 'They are finished — clear the plate.', 'They are pausing, not finished — the plate stays.'], correct: 3, explain: 'Cutlery resting apart means the guest is pausing, not finished. Clearing now would interrupt them mid-meal — the plate stays.' },
      { q: 'A guest has laid their fork and knife together, side by side across the plate. What is your cue?', options: ['They are finished — clear in the next natural pause.', 'They want to keep the cutlery for the next course.', 'They are signalling a complaint.', 'Leave the plate until they ask you to take it.'], correct: 0, explain: 'Cutlery side by side across the plate means the guest is finished. That is your cue to clear in the next natural pause.' },
      ...
      { q: 'Why does the lesson call the place setting "a language"?', options: ['Because the setting changes every night to show the menu.', 'Because each piece is labelled for the guest.', 'Because it guides the guest through the meal and tells you, through where the cutlery sits, exactly where they are in it.', 'Because guests are expected to learn it before they arrive.'], correct: 2, explain: 'The setting works both ways: it maps the meal for the guest and shows their progress back to you. Your job is to know it well so the guest never has to.' },
    ],
  },
];
...
const fineDiningTableSetupLessons: Lesson[] = [
  {
    ...
    quiz: [
      { q: 'What does "mise en place" mean, and why does it matter so much in fine dining?', options: ['It means setting up as fast as possible before doors open.', 'It only matters on fully booked nights.', 'It is the kitchen\'s job, not the floor\'s.', '"Everything in its place" — the room is set to standard before any guest arrives, so the standard is already met when service begins.'], correct: 3, explain: 'Mise en place means "everything in its place." A room set to standard carries the evening with ease — the setup is not getting ready for the standard, it is the standard.' },
      { q: 'How is cutlery laid at a cover?', options: ['Outside-in in course order, forks left and knives and spoons right, each handle the same distance from the table edge.', 'Inside-out, starting from the plate.', 'Bunched close to the plate to save space.', 'In any order, as long as forks and knives are together.'], correct: 0, explain: 'Cutlery is laid outside-in in the order courses are used, forks left, knives and spoons right, with every handle the same distance — about a thumb\'s width — from the edge.' },
      ...
      { q: 'What is the rule for a candle or centrepiece on a fine dining table?', options: ['It only matters for special occasions.', 'The taller and more dramatic, the better.', 'It stays low enough that guests can see one another across the table, and the candle is clean and lit at the right moment.', 'It should sit a little off-centre to look interesting.'], correct: 2, explain: 'The centrepiece stays low enough that no guest has to lean around it to meet the eye of the person opposite — nothing on the table should block the guests from each other.' },
      { q: 'You\'ve finished setting a table. What is the last check the lesson recommends?', options: ['Photograph it for the pre-service brief.', 'Move on — if each piece is placed, the table is done.', 'Ask a colleague to glance at it as they pass.', 'Look at the finished table from the guest\'s chair and eye level, not from where you stand.'], correct: 3, explain: 'Sit or crouch in the guest\'s chair and look at the table from their eye level. A setting that looks right when you stand over it can look quite different from where the guest sits.' },
    ],
  },
  {
    ...
    quiz: [
      { q: 'What is the correct way to clean and prepare a wine glass for the table?', options: ['Polish it over steam holding the base, work up the bowl without touching the rim, and check it against the light first.', 'Hold it by the rim for control and breathe on it to clean it.', 'Only polish glasses for guests who order wine.', 'Wipe it quickly by the bowl and set it down.'], correct: 0, explain: 'Polish over steam, hold by the base, never touch the rim, and check against the light. A glass goes to the table perfect, or it does not go at all.' },
      ...
      { q: 'What is the standard for how a tablecloth is laid?', options: ['Doubled up so spills don\'t reach the table.', 'Pulled tight on the guests\' side, looser behind.', 'Pressed, spotless, laid square, with an even drop on all sides — one clean cloth, never a patched or doubled layer.', 'Whatever drop length the cloth happens to give.'], correct: 2, explain: 'The cloth is pressed, spotless, and square with an even drop on every side — a single clean cloth, never patched or doubled to hide a flaw underneath.' },
      { q: 'Why are napkins folded to one same style across every cover?', options: ['So guests know which napkin is theirs.', 'It makes the napkins easier to count.', 'It\'s only for looks and not really important.', 'Sameness shows a house in control of its details; mismatched folds show the opposite.'], correct: 3, explain: 'The fold is the same across every cover so the room looks like one careful setting. Matching folds show control of detail; different ones show it is missing.' },
      { q: 'Where should a chip, spot, or mark on glassware be found?', options: ['Away from the table, during the check — the table is the wrong place to find a flaw.', 'It doesn\'t matter where, as long as it\'s caught in the end.', 'By the guest, who can ask for a new one.', 'At the table, where the light is best for checking.'], correct: 0, explain: 'Every piece is checked away from the table. By the time glassware reaches the guest it has already passed the check — the table is never where a flaw is found.' },
    ],
  },
  {
    id: 'fdt-sideboard',
    ...
    quiz: [
      ...
      { q: 'When should the service station be stocked?', options: ['Once a guest asks for something you\'ve run out of.', 'Whenever you notice it\'s running low, mid-service.', 'Fully before service, and topped up at every quiet moment — never dug through empty in the middle of a rush.', 'Only at the end of the night.'], correct: 2, explain: 'Stock before service and at every quiet moment. The time to find you\'re out of an item is before service begins, never as a guest waits for it.' },
      { q: 'Where do personal items — your phone, a drink, your keys — belong during service?', options: ['On the station is fine as long as guests can\'t quite see them.', 'In an apron pocket on the station top.', 'Tucked quietly at the back of the sideboard.', 'Nowhere on the station — personal items are kept off it completely, out of sight.'], correct: 3, explain: 'Personal items never belong on the station. The sideboard holds only the tools of service — anything personal stays out of the room completely.' },
      { q: 'How should the sideboard be placed and screened?', options: ['Its working side turned away from the room, with only clean, ready items on top and anything used kept out of sight.', 'In the busiest sightline so you can reach it fastest.', 'It doesn\'t matter where it faces.', 'Facing the room so guests can see how tidy you are.'], correct: 0, explain: 'The working side turns away from the room. Only clean, ready items sit on top; anything used or messy is kept below, behind, or cleared at once — the guest\'s eye slides past it.' },
  ...
  },
  {
    ...
    quiz: [
      { q: 'What is the right level for music in a fine dining room?', options: ['As quiet as possible until guests ask for more.', 'Loud enough to fill any silence between tables.', 'Under the talk — a table should be able to talk easily without raising their voices.', 'A fixed level set once at the start of the night.'], correct: 2, explain: 'Music sits under the talk, never over it. The test is whether a table can talk easily without raising their voices — and the right level changes as the room fills and empties.' },
      { q: 'What is a "dead zone," and how should you handle the tables in one?', options: ['An area of the floor you keep guests out of.', 'A table kept for staff breaks.', 'A table no one books — leave it unset.', 'A seat that gets a poorer version of the evening — by the kitchen, in a draught, in shadow — so you give it more attention and care, not less.'], correct: 3, explain: 'Dead zones are seats that quietly get a poorer evening — by the kitchen door, in a draught, in shadow. You find them before service does and give those tables more attention, never less.' },
      { q: 'What is the fifteen-minute look around?', options: ['A standing habit of pausing every fifteen minutes to read the whole room as a guest would — light, sound, temperature, energy — and fixing any change.', 'A fifteen-minute break for staff to reset.', 'A check you do only when the room feels off.', 'A timed walk to check every table has ordered.'], correct: 0, explain: 'Every fifteen minutes you pause and read the room as a guest would, catch any change in light, sound, or temperature, look for what is missed, and fix it quietly — a habit, not a reaction.' },
      ...
      { q: 'Why does the lesson say atmosphere is "felt as one thing"?', options: ['Because atmosphere is the kitchen\'s job, not the floor\'s.', 'Because only the lighting really matters to guests.', 'Because guests feel sound, light, and warmth as one impression — a perfect plate in a too-loud, too-warm room still lands as a poor evening.', 'Because the parts can each be perfected and forgotten.'], correct: 2, explain: 'Guests don\'t feel the parts separately — they feel the room as one thing. Even a perfect plate, served into a room that is too loud and too warm, still lands as a poor evening.' },
    ],
  },
];
...
export const fineDiningAnticipatoryLessons: Lesson[] = [
  {
    ...
    quiz: [
      { q: 'What is the 15-second scan?', options: ['A check you do once at the start of service.', 'A timed sweep to see which tables have ordered.', 'A quick glance at your phone between tables.', 'A real, careful look at your whole section — every glass, plate, and face — on every single pass through it.'], correct: 3, explain: 'The scan is a real look — not a glance — at every glass, plate, and face, done every time you pass through your section, until it becomes automatic.' },
      { q: 'A guest is looking around the room. What does it mean, and what do you do?', options: ['They are searching for you — meet their eye with a small nod so they know you are coming, then go to them.', 'They are admiring the room — leave them be.', 'Nothing — wait until they raise a hand.', 'They are bored — bring the bill.'], correct: 0, explain: 'A guest looking around is searching for you. Catch it fast, acknowledge them with a small nod so they feel seen, and go to them.' },
      ...
      { q: 'A guest has placed their knife and fork together on the plate. What is this telling you?', options: ['They are pausing and will eat more.', 'They want more of the dish.', 'They are finished — clear the plate in the next natural pause.', 'They are unhappy with the food.'], correct: 2, explain: 'Cutlery placed together means finished. The table is showing you it is ready to move on — clear quietly in the next natural pause.' },
      { q: 'Why does the lesson say every table has its own rhythm?', options: ['Because the kitchen sets the pace for every table.', 'Because rhythm only matters for large groups.', 'Because all tables should be served at the same speed.', 'Because a couple, a group of friends, a business lunch, and a family each move at a different speed and want a different kind of attention.'], correct: 3, explain: 'Each type of table moves differently and wants a different kind of attention. Read which kind of table you have early, and serve its rhythm, not your own.' },
    ],
  },
  {
    id: 'fda-pacing',
    ...
    quiz: [
      { q: 'How do you know a table is ready for the next course?', options: ['When they are nearly finished and the energy is right — you read the plates and the table, not the clock.', 'When the kitchen tells you the dish is ready.', 'When the table is the last one left in your section.', 'When a set number of minutes has passed.'], correct: 0, explain: 'A table is ready when they are nearly finished, not when the clock says so. Read the plates and the energy of the table, and let that set the pace.' },
      ...
      { q: 'Who controls the timing of the courses?', options: ['No one — the courses come on a fixed schedule.', 'The kitchen, who send food when it is ready.', 'You — you read the table and tell the kitchen when to hold or send the next course.', 'The guest, who must ask for each course.'], correct: 2, explain: 'You are the link between the table and the kitchen. The pace is yours to manage — you tell the kitchen when to hold and when to send, based on what you read from the table.' },
      { q: 'A guest feels rushed even though they have not said anything. What likely caused it?', options: ['The room was too quiet.', 'They were given too much time between courses.', 'The food was too good.', 'Clearing too fast, hovering for the next order, or bringing the bill before it was wanted.'], correct: 3, explain: 'A rushed guest feels it without a word being said. Clearing too fast, hovering, or bringing the bill early all signal that their table is needed back. Slow down sooner than you speed up.' },
      { q: 'When should you use a check-in line like "May I bring your next course?"', options: ['When you are genuinely unsure of the pace — to confirm without rushing the table.', 'Never — you should always guess the pace silently.', 'Only when the kitchen is behind.', 'On every table, after every course.'], correct: 0, explain: 'A short check-in confirms the pace without rushing the table. Use it when you are unsure, not as a habit on every course.' },
    ],
  },
  {
    id: 'fda-personal',
    ...
    quiz: [
      ...
      { q: 'The plates are ready to go to a table of four. What does the standard ask of you?', options: ['Ask the kitchen to label each plate.', 'Carry them out and ask "who had the fish?" at the table.', 'Remember who ordered what, and serve each plate to the right guest without asking.', 'Put all the plates in the middle for guests to sort out.'], correct: 2, explain: 'Remembering who ordered what, and serving each plate to the right guest without asking, is a small touch that makes a guest feel cared for.' },
      { q: 'A returning guest mentioned on a past visit that tonight is their anniversary. What do you do?', options: ['Mention it loudly so the whole room joins in.', 'Wait for them to bring it up again first.', 'Nothing — it is not your place to bring it up.', 'Mark it warmly — a genuine word, a small gesture, a real "congratulations."'], correct: 3, explain: 'When a guest shares an occasion, mark it warmly with a genuine word or gesture. These are exactly the moments a guest remembers and talks about later.' },
      { q: 'How often should you keep a guest\'s allergy in mind?', options: ['Through every course, every plate, and every drink — it is not a one-time note.', 'Only for the main course.', 'Only if the kitchen reminds you.', 'Just once, when they first mention it.'], correct: 0, explain: 'An allergy is not a one-time note. Carry it with you through every course and every plate — one missed detail can turn a special evening into a frightening one.' },
  ...
  },
  {
    ...
    quiz: [
      { q: 'What is the golden rule of recovery?', options: ['Explain exactly what went wrong so the guest understands.', 'Fix the problem as fast as possible and move on.', 'Leave the guest feeling better than if nothing had gone wrong at all.', 'Always offer a discount when something goes wrong.'], correct: 2, explain: 'The goal is not just to fix the problem — it is to leave the guest feeling better than if nothing had gone wrong. Handled with grace, a problem can become a warm memory.' },
      { q: 'A guest takes one bite, frowns, and sets the fork down. What do you do?', options: ['Ignore it — they may just be pausing.', 'Take the plate away without asking.', 'Wait until they call you over to complain.', 'Step in gently and ask warmly, "How are you finding everything?"'], correct: 3, explain: 'A bite set down and a small frown are early warning signs. Step in gently and check warmly — this opens the door for the guest to tell you, without making it a complaint.' },
      { q: 'Where is the best place to catch a kitchen mistake?', options: ['At the pass, before the plate ever leaves your hand for the table.', 'After the meal, in the debrief.', 'It does not matter where you catch it.', 'At the table, after the guest points it out.'], correct: 0, explain: 'Check every plate before it leaves your hand. Catching a wrong dish or temperature at the pass means the best recovery of all — the one that never reaches the guest.' },
      ...
      { q: 'What is the difference between proactive and reactive recovery?', options: ['Proactive is only for regulars.', 'Proactive is slower; reactive is faster.', 'Proactive catches the problem early, often before the guest fully notices; reactive waits for the complaint, then apologizes.', 'There is no real difference.'], correct: 2, explain: 'Reactive recovery waits for the guest to complain. Proactive recovery reads what is about to go wrong and gets there first — fixing it so smoothly the evening is never disturbed.' },
    ],
  },
];
...
const fineDiningMenuKnowledgeLessons: Lesson[] = [
  {
    ...
    quiz: [
      { q: 'What three things should you know about every dish on the menu?', options: ['The exact menu wording, word for word.', 'The chef\'s name, the supplier, and the recipe.', 'The price, the portion size, and the plate it comes on.', 'The key ingredients, how it is cooked, and how it tastes.'], correct: 3, explain: 'For every dish, know the key ingredients, the main cooking method, and how it tastes. Those three let you speak about any plate with confidence.' },
      { q: 'How can a guest tell the difference between real knowledge and memorized lines?', options: ['A server with real knowledge can answer follow-up questions and explain a dish in their own words; one with memorized lines goes blank.', 'Only the manager can tell the difference.', 'It only shows when the dish is very unusual.', 'They can\'t — the words sound the same either way.'], correct: 0, explain: 'Real knowledge lets you answer questions and explain a dish in your own words. Memorized lines fall apart the moment a guest asks something past the menu wording.' },
      ...
      { q: 'What is the best way to learn how a dish really tastes?', options: ['Guess from the ingredients listed.', 'Read the menu description a few more times.', 'Taste the dish yourself whenever the kitchen allows it.', 'Ask another guest what they thought.'], correct: 2, explain: 'Nothing replaces having tried it yourself. Taste the dishes when you can — your own experience beats any description on a card.' },
      { q: 'A guest asks if a dish contains nuts and you are not sure. What should you do?', options: ['Tell them it\'s fine to avoid worrying them.', 'Suggest they order something else instead.', 'Guess, since it probably doesn\'t.', 'Know your menu\'s common allergens in advance — and if you are ever unsure, check with the kitchen before answering.'], correct: 3, explain: 'You should know which dishes contain common allergens like nuts, shellfish, and dairy. When you are not certain, never guess — check with the kitchen before you answer.' },
    ],
  },
  {
    ...
    quiz: [
      { q: 'How should you start a description of a dish?', options: ['With the best part — the flavour, texture, or the one thing a guest will remember.', 'With the price, so they know what to expect.', 'With how long it takes to cook.', 'With the full list of ingredients in menu order.'], correct: 0, explain: 'Lead with what makes the dish special. One strong line about the best part beats a full list of ingredients.' },
      ...
      { q: 'What is the difference between informing and overselling?', options: ['Overselling is fine as long as the dish is good.', 'There is no difference — both help the guest.', 'Informing helps the guest choose honestly; overselling pushes a dish and makes the guest put their guard up.', 'Informing is for cheap dishes, overselling for expensive ones.'], correct: 2, explain: 'Your job is to help the guest choose, not to push the priciest dish. A guest who feels informed trusts you; a guest who feels sold to puts their guard up.' },
      { q: 'How long should a good dish description be?', options: ['One word, so you don\'t bore the guest.', 'A full minute, like a small speech.', 'As long as possible, to cover every detail.', 'Usually two or three sentences — what it is, the best thing about it, and how it tastes.'], correct: 3, explain: 'Two or three sentences is usually enough. Say what the dish is, the best thing about it, and how it tastes, then stop — a long description sounds scripted.' },
      { q: 'What is the "friend test" for describing a dish?', options: ['Describing it the way you would tell a friend — the best part, simply and warmly, with no fancy words.', 'Only describing dishes your friends would like.', 'Checking the description with a colleague before service.', 'Asking a friend to taste the dish first.'], correct: 0, explain: 'How would you tell a friend about the dish? You\'d say the best part, simply and warmly — not list every ingredient. That is exactly how a great description sounds.' },
    ],
  },
  {
    ...
    quiz: [
      ...
      { q: 'What does it mean when a wine is "dry"?', options: ['It is served without ice.', 'It has been open too long and gone flat.', 'It is simply not sweet — most wines served with a meal are dry.', 'It is a very strong, high-alcohol wine.'], correct: 2, explain: '"Dry" just means not sweet. Most meal wines are dry; sweet wines are more common with dessert. A guest who likes dry wine does not want it sweet.' },
      { q: 'What does "body" mean when talking about wine?', options: ['The region the wine comes from.', 'How old the wine is.', 'The colour of the wine.', 'How heavy or light the wine feels in the mouth — light feels delicate, full-bodied feels rich.'], correct: 3, explain: '"Body" is how heavy or light a wine feels. Light wines suit lighter dishes, full-bodied wines suit richer ones — this one idea helps you guide most choices.' },
      { q: 'A guest tells you they do not drink alcohol. How should you handle it?', options: ['Offer your non-alcoholic options with the same care and warmth as you would a fine wine.', 'Tell them the menu is really built around the wine.', 'Leave them to ask if they want something.', 'Just bring them tap water without asking.'], correct: 0, explain: 'Every guest deserves the same care. Know your non-alcoholic options — sparkling water, soft drinks, juices, mocktails — and offer them with the same warmth as a fine wine.' },
  ...
  },
  {
    ...
    quiz: [
      { q: 'A guest asks "What do you recommend?" What is the best response?', options: ['"Whatever you feel like is fine."', '"It\'s all good, honestly."', 'Name one or two dishes you genuinely like, and say why in a sentence.', 'Recommend the most expensive dish on the menu.'], correct: 2, explain: 'A guest asking this wants your honest opinion. Name one or two dishes you really like and say why — a confident, personal recommendation is deeply reassuring.' },
      { q: 'A guest says they have a serious nut allergy and asks if a dish is safe. What do you do?', options: ['Suggest they just avoid that one dish.', 'Guess based on the ingredients you can see.', 'Tell them it\'s probably fine.', 'Take it seriously, and if you are not completely sure, check with the kitchen before answering.'], correct: 3, explain: 'Never guess on an allergy — it can matter to a guest\'s health. Take it seriously, and when you are not completely sure, check with the kitchen before you answer.' },
      { q: 'A guest asks a question and you genuinely don\'t know the answer. What is the professional move?', options: ['Say calmly "let me check on that for you," then go and find out.', 'Tell them you\'re not sure and leave it there.', 'Change the subject to something you do know.', 'Make up a confident answer so you don\'t look unsure.'], correct: 0, explain: 'Never guess. A calm, confident "let me check on that for you" is far better than a wrong answer said with a smile — then you go and find out.' },
      ...
      { q: 'Why can saying "I don\'t know, let me check" actually build trust?', options: ['Because it gives you time to take a break.', 'It can\'t — guests want instant answers only.', 'Because an honest, confident "let me check" followed by the real answer reassures the guest far more than a wrong answer would.', 'Because it makes the guest feel sorry for you.'], correct: 2, explain: 'Done right, even "I don\'t know" builds trust. An honest "let me check," followed by coming back with the real answer, reassures a guest far more than a confident wrong answer.' },
    ],
  },
];
