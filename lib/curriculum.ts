...
const greetingsLessons: Lesson[] = [
  {
    ...
    learn: [
      { type: 'intro', text: 'The first five seconds set the emotional tone for the entire visit. A guest who walks into Brgr Haus and is acknowledged immediately feels welcomed. A guest who has to look around, make eye contact twice, and wait — already feels like an afterthought. It costs nothing to greet quickly. It costs a lot not to.' },
      ...
      { type: 'do-dont', title: 'In practice', items: [
        { do: '"Good evening, welcome to Brgr Haus! Table for two?"', dont: 'Continuing to clean a table for 15 seconds before looking up.' },
    ...
    quiz: [
      ...
      { q: 'You have a reservation for the Santos family. They walk in. Best opening?', options: ['"How many in your party?"', '"Santos? Right this way."', '"Mr. Santos, welcome to Brgr Haus! We\'ve been expecting you."', '"Name on the reservation?"'], correct: 2, explain: 'Using their name + warmth + context ("we\'ve been expecting you") is the high-impact opening that makes guests feel like VIPs.' },
      { q: 'What is the Brgr Haus standard for greeting speed?', options: ['30 seconds', '10 seconds', '5 seconds', '1 minute'], correct: 2, explain: '5 seconds is the standard. Every guest should be acknowledged within 5 seconds of walking through the door.' },
      ...
      { q: 'A regular guest, Erik, walks in every Tuesday. You recognize him. Best move?', options: ['Standard greeting: "Welcome to Brgr Haus."', '"Erik! Good to see you — your usual spot in the corner?"', '"Name on reservation?"', '"Table for one?"'], correct: 1, explain: 'Regulars are gold. Using their name, referencing their habit — this is what creates loyalty. It costs 3 seconds and earns a lifetime.' },
    ],
  },
  {
    id: 'guide-dont-point',
  ...
  },
  {
    ...
    learn: [
      ...
      { type: 'lang-grid', items: [
        { lang: 'English', flag: '🇺🇸', formal: 'Welcome to Brgr Haus, great to have you here. Table for [X]?', casual: 'Hey! Welcome in — good to see you. How many are joining you tonight?', tip: 'Americans respond to enthusiasm and warmth. Smile wide, make strong eye contact. Acknowledge occasions if you know them.' },
        { lang: 'Dutch', flag: '🇳🇱', formal: 'Welkom bij Brgr Haus. Fijn dat u er bent. Tafel voor [X]?', casual: 'Hoi! Welkom bij Brgr Haus — gezellig dat jullie er zijn!', tip: 'Dutch guests value efficiency and directness. Friendly but not overdone. Get to seating quickly — they appreciate it.' },
        { lang: 'Spanish', flag: '🇪🇸', formal: 'Bienvenidos a Brgr Haus. Qué bueno tenerlos aquí. ¿Mesa para cuántos?', casual: '¡Hola! Bienvenidos — qué gusto verlos. ¿Cuántos son?', tip: 'Venezuelan and Colombian guests appreciate warmth and an unhurried welcome. Ask how they\'re doing and mean it. Small talk is a sign of respect.' },
        { lang: 'Papiamentu', flag: '🇨🇼', formal: 'Bon biní na Brgr Haus! Kon ta bai? ¿Mesa pa kuantu persona?', casual: 'Bon biní! Kon ta bai — tur kos ta bon?', tip: 'Papiamentu from a non-local staff member earns instant trust and warmth. Local guests will love you for trying. They will help you improve.' },
      ]},
    ...
    quiz: [
      { q: 'A Dutch couple walks in — well-dressed, efficient body language. Best opening?', options: ['"Hey!! Welcome, so great to see you!!"', '"Welkom bij Brgr Haus. Fijn dat u er bent. Tafel voor twee?"', '"Welcome! Can I get a name for the reservation?"', '"Bon biní! Kon ta bai?"'], correct: 1, explain: 'Dutch guests appreciate a clean, efficient, warm greeting in their own language. Not over-the-top — just genuinely professional.' },
      ...
      { q: 'A Venezuelan family arrives. They\'re speaking Spanish. What\'s the highest-impact opening?', options: ['"Welcome to Brgr Haus, how many?"', '"¡Hola! Bienvenidos — qué gusto verlos. ¿Cuántos son?"', '"Table for four?"', '"Welkom bij Brgr Haus."'], correct: 1, explain: 'Spanish + genuine warmth + interest in their group = instant connection. This family will remember this moment.' },
  ...
  },
  {
    ...
    learn: [
      {
        type: 'intro',
        text: 'Every table at Brgr Haus tells you something before anyone says a word. A couple on a date wants presence, not interruption. A group of friends wants energy and fun. A solo businessman wants precision and speed. Read the room before you open your mouth.',
      },
      {
        type: 'callout',
        tone: 'rule',
...
const serviceFlowLessons: Lesson[] = [
  {
    ...
    desc: 'The complete Brgr Haus service standard, start to finish',
    duration: '10 min',
    xp: 80,
    status: 'available',
    scenarioId: 'order-taking-allergy',
    learn: [
      { type: 'intro', text: 'Every perfect service experience at Brgr Haus follows the same 10-step sequence. This is not a rigid script — it\'s a framework. Master the sequence and it becomes invisible. Skip steps and guests feel it, even if they can\'t name it.' },
      { type: 'steps', title: 'The 10 Steps', items: [
        { num: 1, title: 'Reception', body: 'Immediate greeting within 5 seconds. Confirm reservation. Use their name.', badge: 'Always' },
        { num: 2, title: 'Seating', body: 'Guide — never point. Walk them to the table, menu open, one line about the experience.', badge: 'Always' },
        { num: 3, title: 'First Contact', body: 'Offer water immediately. Brief, genuine introduction to what makes Brgr Haus different.', badge: 'Within 2 min' },
        { num: 4, title: 'Drinks', body: 'Proactive suggestion — don\'t wait to be asked. Brief recommendation with a reason.', badge: 'Proactive' },
        { num: 5, title: 'Order Taking', body: 'Listen actively. Confirm everything. Detect and acknowledge allergies/restrictions.', badge: 'Confirm twice' },
        ...
        { num: 7, title: 'Follow-up', body: 'Check 2-3 minutes after food arrives. Not "Is everything OK?" — ask about flavors.', badge: '2-3 min' },
        { num: 8, title: 'Clearing', body: 'Never clear while someone is still eating. Synchronized clearing once the last person finishes.', badge: 'Never rush' },
  ...
  },
  {
    ...
    desc: 'Never wait to be asked — suggest with confidence',
    duration: '7 min',
    xp: 50,
    status: 'available',
    scenarioId: 'drinks-upsell',
    learn: [],
    quiz: [],
  },
  {
    id: 'order-taking',
    title: 'Order Taking & Allergy Protocol',
    desc: 'Confirm every order. Handle restrictions immediately.',
    duration: '9 min',
    xp: 60,
    status: 'available',
    learn: [],
  ...
  {
    id: 'food-service',
    title: 'Food Service & Follow-up',
    desc: 'Synchronized service. The right check-in question.',
    duration: '8 min',
    xp: 55,
    status: 'available',
    learn: [],
  ...
  {
    id: 'close',
    title: 'The Close & Invitation to Return',
    desc: 'The last impression is as important as the first',
    duration: '6 min',
    xp: 40,
    status: 'available',
    learn: [],
