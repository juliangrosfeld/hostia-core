...
export const RECENT_ACTIVITY = [
  { who: 'Jordan Blake', what: 'completed "The 10-Step Service Flow"', score: 96, when: '5m ago', type: 'completion' as const },
  { who: 'Alex Morgan', what: 'earned "Floor Master" badge', when: '20m ago', type: 'badge' as const },
  { who: 'Sam Okafor', what: 'completed roleplay: Overcooked Menu Item Complaint', score: 90, when: '1h ago', type: 'roleplay' as const },
  { who: 'Quinn Torres', what: 'started Lesson 1: The 5-Second Rule', when: '3h ago', type: 'start' as const },
  { who: 'Morgan Ellis', what: 'completed "Language & Storytelling"', score: 88, when: '30m ago', type: 'completion' as const },
  { who: 'Drew Patel', what: 'scored 36 on Service Flow drill', when: '8 days ago', type: 'low-score' as const },
];
